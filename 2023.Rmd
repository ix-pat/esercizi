...
`r punti_p()` Si $\hat\theta$ uno stimatore per $\theta$ tale che $E(\hat\theta)=\theta$. Di quale proprietà gode $\hat\theta$? 
...
`r punti_p()` Si $\hat\theta$ uno stimatore per $\theta$ tale che $E(\hat\theta)=\theta$ e $\lim_{n\to\infty} V(\hat\theta)=0$. Di quale proprietà gode $\hat\theta$? 
...
`r punti_p()` Sia $\hat\theta$ uno stimatore per $\theta$. Cosa significa dire che $\hat\theta$ è consistente?
...
`r punti_p()` Sia $\hat\theta$ uno stimatore per $\theta$. Cosa significa dire che $\hat\theta$ è corretto asintoticamente?
...
`r punti_p()` Sia $\hat\theta$ uno stimatore per $\theta$ tale che 
...
`r punti_p()` `r punti_p()` Sia $\hat\theta$ uno stimatore per $\theta$ tale che 
\[V(\hat\theta)=2\frac\theta {\sqrt{n}};~~~~E(\hat\theta)=\theta\frac{n+2}{n-1}\]
...
`r punti_p(nex = T)` Calcola la probabilità che almeno uno dei due eventi sia vero, ovvero la probabilità di $A \cup B$.
...
`r punti_p()` Qual è la probabilità di avere **esattamente** uno solo due eventi sia vera?
