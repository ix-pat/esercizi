...
Siccome \(z_{0.01}=2.3263<z_\text{obs}=2.0616<z_{0.05}=1.6449\), quindi \textbf{rifiuto} \(H_0\) al 5\%,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-65-1} \end{center}
...
Siccome \(z_{0.05}=-1.6449<z_\text{obs}=-1.5492<z_{0.1}=-1.2816\), indecisione sul rifiuto di \(H_0\) al 10\%,
...
Siccome \(z_{0.005}=2.5758<|z_\text{obs}|=2.0328<z_{0.025}=1.96\), quindi \textbf{rifiuto} \(H_0\) al 5\%,
...
Siccome \(t_{20-1;0.001}=-3.5794<t_\text{obs}=-2.6729<t_{20-1;0.01}=-2.5395\), quindi \textbf{rifiuto} \(H_0\) all'1\%,
...
Siccome \(t_{30-1;0.01}=2.462<t_\text{obs}=1.7951<t_{30-1;0.05}=1.6991\), quindi \textbf{rifiuto} \(H_0\) al 5\%,
...
Siccome \(t_{26-1;0.005}=2.7874<|t_\text{obs}|=2.5<t_{26-1;0.025}=2.0595\), quindi \textbf{rifiuto} \(H_0\) al 5\%,
...
Siccome \(t_{30-2;0.001}=3.4082<t_\text{obs}=2.4706<t_{30-2;0.01}=2.4671\), quindi \textbf{rifiuto} \(H_0\) all'1\%,
...
Siccome \(t_{33-2;0.05}=1.6955<t_\text{obs}=1.3944<t_{33-2;0.1}=1.3095\), indecisione sul rifiuto di \(H_0\) al 10\%,
...
Siccome \(t_{33-2;0.025}=2.0395<|t_\text{obs}|=1.9846<t_{33-2;0.05}=1.6955\), indecisione sul rifiuto di \(H_0\) al 10\%,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-84-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-87-1} \end{center}
...
Siccome \(\chi^2_{2;0.05}=5.9915<\chi^2_\text{obs}=5.97402597402597<\chi^2_{2;0.1}=4.6052\), indecisione sul rifiuto di \(H_0\) al 10\%, \(0.05<p_\text{value}<0.1\),
...
Siccome \(\chi^2_{2;0.001}=13.8155<\chi^2_\text{obs}=11.3674560733384<\chi^2_{2;0.01}=9.2103\), quindi \textbf{rifiuto} \(H_0\) all'1\%, \(0.001<p_\text{value}<0.01\),
...
Siccome \(\chi^2_\text{obs}=49.5915009194479>\chi^2_{4;0.001}=18.4668\), quindi \textbf{rifiuto} \(H_0\) sotto all'1‰, \(p_\text{value}<0.001\),
...
Siccome \(\chi^2_{2;0.001}=13.82<\chi^2_\text{obs}=10.1333<\chi^2_{2;0.01}=9.21\), quindi \textbf{rifiuto} \(H_0\) all'1\%, \(0.001<p_\text{value}<0.01\),
...
Siccome \(\chi^2_\text{obs}=50.1457>\chi^2_{4;0.001}=18.4668\), quindi \textbf{rifiuto} \(H_0\) sotto all'1‰, \(p_\text{value}<0.001\),

\emph{estremamente significativo} \(\fbox{***}\).

\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-97-1} \end{center}
...
Siccome \(t_{51-2;0.025}=2.0096<|t_\text{obs}|=1.6869<t_{51-2;0.05}=1.6766\), indecisione sul rifiuto di \(H_0\) al 10\%,
...
Attenzione il calcolo del \(p_\text{value}\) con la \(T\) è puramente illustrativo e non può essere riprodotto senza una calcolatrice statistica adeguata.\[
 0.05 < p_\text{value}= 0.097989 \leq 0.1 
\]
...
Siccome \(t_\text{obs}=7.4808>t_{51-2;0.001}=3.2651\), quindi \textbf{rifiuto} \(H_0\) sotto all'1‰,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-105-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-108-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-112-1} \end{center}
...
Siccome \(t_\text{obs}=6.5843>t_{16-2;0.001}=3.7874\), quindi \textbf{rifiuto} \(H_0\) sotto all'1‰,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-113-1} \end{center}

Il \(p_{\text{value}}\) è

\[ p_{\text{value}} = P(T_{16-2}>6.58)=0.000006 \]
...
Siccome \(t_\text{obs}=-5.8892<t_{16-2;0.001}=-3.7874\), quindi \textbf{rifiuto} \(H_0\) sotto all'1‰,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-114-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-119-1} \end{center}
...
Siccome \(|t_\text{obs}|=0.4327<t_{11-2;0.05}=1.8331\), quindi \textbf{non} rifiuto \(H_0\) a \textbf{nessun}
livello di significatività,

\(p_\text{value}>0.1\),
\emph{non significativo}

\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-120-1} \end{center}

Il \(p_{\text{value}}\) è

\[ p_{\text{value}} = P(|T_{11-2}|>|0.43|)=2P(T_{11-2}>0.43)=0.675401 \]

Attenzione il calcolo del \(p_\text{value}\) con la \(T\) è puramente illustrativo e non può essere riprodotto senza una calcolatrice statistica adeguata.\[
 0.1 < p_\text{value}= 0.675401 \leq 1 
\]
...
Siccome \(t_{11-2;0.025}=2.2622<|t_\text{obs}|=1.8442<t_{11-2;0.05}=1.8331\), indecisione sul rifiuto di \(H_0\) al 10\%,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-121-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-126-1} \end{center}
...
Siccome \(t_{16-2;0.0005}=4.1405<|t_\text{obs}|=3.8133<t_{16-2;0.005}=2.9768\), quindi \textbf{rifiuto} \(H_0\) all'1\%,
...
\[ p_{\text{value}} = P(|T_{16-2}|>|3.81|)=2P(T_{16-2}>3.81)=0.001900 \]

Attenzione il calcolo del \(p_\text{value}\) con la \(T\) è puramente illustrativo e non può essere riprodotto senza una calcolatrice statistica adeguata.\[
 0.001 < p_\text{value}= 0.001900 \leq 0.01 
\]
...
Siccome \(t_{16-2;0.05}=-1.7613<t_\text{obs}=-1.4936<t_{16-2;0.1}=-1.345\), indecisione sul rifiuto di \(H_0\) al 10\%,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-129-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-134-1} \end{center}
...
Siccome \(t_\text{obs}=0.9841<t_{15-2;0.1}=1.3502\), quindi \textbf{non} rifiuto \(H_0\) a \textbf{nessun}
livello di significatività,
...
\[ p_{\text{value}} = P(T_{15-2}>0.98)=0.171525 \]

Attenzione il calcolo del \(p_\text{value}\) con la \(T\) è puramente illustrativo e non può essere riprodotto senza una calcolatrice statistica adeguata.\[
 0.1 < p_\text{value}= 0.171525 \leq 1 
\]
...
Siccome \(t_{15-2;0.01}=-2.6503<t_\text{obs}=-2.5191<t_{15-2;0.05}=-1.7709\), quindi \textbf{rifiuto} \(H_0\) al 5\%,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-137-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-141-1} \end{center}
...
Siccome \(t_\text{obs}=11.5822>t_{16-2;0.001}=3.7874\), quindi \textbf{rifiuto} \(H_0\) sotto all'1‰,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-146-1} \end{center}

Il \(p_{\text{value}}\) è

\[ p_{\text{value}} = P(T_{16-2}>11.58)=7e-09 \]
...
Siccome \(t_{15-2;0.0005}=4.2208<|t_\text{obs}|=3.0603<t_{15-2;0.005}=3.0123\), quindi \textbf{rifiuto} \(H_0\) all'1\%,
...
Siccome \(t_{5-2;0.025}=3.1824<|t_\text{obs}|=2.6191<t_{5-2;0.05}=2.3534\), indecisione sul rifiuto di \(H_0\) al 10\%,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-152-1} \end{center}

Il \(p_{\text{value}}\) è

\[ p_{\text{value}} = P(|T_{5-2}|>|2.62|)=2P(T_{5-2}>2.62)=0.079064 \]

Attenzione il calcolo del \(p_\text{value}\) con la \(T\) è puramente illustrativo e non può essere riprodotto senza una calcolatrice statistica adeguata.\[
 0.05 < p_\text{value}= 0.079064 \leq 0.1 
\]
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-156-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-160-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-164-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-167-1} \end{center}
...
Siccome \(|t_\text{obs}|=4.3148>t_{33-2;0.0005}=3.6335\), quindi \textbf{rifiuto} \(H_0\) sotto all'1‰,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-179-1} \end{center}
...
Siccome \(t_\text{obs}=0.5848<t_{25-2;0.1}=1.3195\), quindi \textbf{non} rifiuto \(H_0\) a \textbf{nessun}
livello di significatività,

\(p_\text{value}>0.1\),
\emph{non significativo}

\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-187-1} \end{center}

Il \(p_{\text{value}}\) è

\[ p_{\text{value}} = P(T_{25-2}>0.58)=0.282173 \]

Attenzione il calcolo del \(p_\text{value}\) con la \(T\) è puramente illustrativo e non può essere riprodotto senza una calcolatrice statistica adeguata.\[
 0.1 < p_\text{value}= 0.282173 \leq 1 
\]
...
Siccome \(\chi^2_{6;0.001}=22.4577<\chi^2_\text{obs}=16.8746527777778<\chi^2_{6;0.01}=16.8119\), quindi \textbf{rifiuto} \(H_0\) all'1\%, \(0.001<p_\text{value}<0.01\),

\emph{molto significativo} \(\fbox{**}\).

\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-196-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-203-1} \end{center}
...
Siccome \(t_\text{obs}=-12.8879<t_{15-1;0.001}=-3.7874\), quindi \textbf{rifiuto} \(H_0\) sotto all'1‰,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-211-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-215-1} \end{center}
...
5.b (\textbf{Punti 4}) È noto che quella fascia di motori ha un consuo medio pari \(23.9~\text{Km/litro}\). Testare che il nuovo motore consumi come gli altri contro l'alternativa che abbia consumi \emph{diversi}.
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-228-1} \end{center}
...
Siccome \(z_{0.01}=-2.3263<z_\text{obs}=-1.6667<z_{0.05}=-1.6449\), quindi \textbf{rifiuto} \(H_0\) al 5\%,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-234-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-241-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-247-1} \end{center}
...
5.a (\textbf{Punti 14}) In un'indagine sull'opinione sul reddito di cittadinanza sono stati intervistate 140 persone che vivono al nord e 170 che vivono al sud: 60 su 140 che vivono al nord sono favorevoli al reddito di cittadinanza mentre 95 su 170 che vivono al sud sono favorevoli.
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-255-1} \end{center}
...
Siccome \(|t_\text{obs}|=19.4256>t_{310-2;0.0005}=3.3224\), quindi \textbf{rifiuto} \(H_0\) sotto all'1‰,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-265-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-273-1} \end{center}
...
Siccome \(|t_\text{obs}|=1.3184<t_{72-2;0.05}=1.6669\), quindi \textbf{non} rifiuto \(H_0\) a \textbf{nessun}
livello di significatività,

\(p_\text{value}>0.1\),
\emph{non significativo}

\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-278-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-291-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-297-1} \end{center}
...
Siccome \(z_\text{obs}=11.7363>z_{0.001}=3.0902\), quindi \textbf{rifiuto} \(H_0\) sotto all'1‰,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-301-1} \end{center}
...
\tightlist
\item
  (\textbf{Punti 14}) Individuare la classe modale.
\end{enumerate}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-309-1} \end{center}
...
\tightlist
\item
  (\textbf{Punti 3}) Quante imprese hanno un bilancio compreso tra \(-4\) mila
  euro e zero.
\end{enumerate}
...
\tightlist
\item
  (\textbf{Punti 2}) La media è risultata essere \(\bar x=8.446\); che
...
\tightlist
\item
  (\textbf{Punti 2}) Siano \(x_1,...,x_n\), \(n\) numeri, \(n\) dispari.
...
\tightlist
\item
  (\textbf{Punti 14}) Calcolare \(P(A\cup B)\).
\end{enumerate}
...
\tightlist
\item
  (\textbf{Punti 3}) Posto \(Z=X-Y\), Calcolare la probabilità che \(P(Z>1|Z\le 2)\).
\end{enumerate}
...
\tightlist
\item
  (\textbf{Punti 2}) Siano \(A\) e \(B\) due eventi diversi dal vuoto.
...
\tightlist
\item
  (\textbf{Punti 2}) Sia \(X\sim\text{Pois}(\lambda=1)\), disegnare la
  funzione di ripartizione \(F(x)\) di \(X\), per \(x\) compreso tra \(-1\) e \(2.5\).
\end{enumerate}

\begin{sol}

\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-312-1} \end{center}
...
\setcounter{enumi}{3}
\item
  (\textbf{Punti 3}) Sia \(\hat \lambda\) lo stimatore di massima verosimiglianza di \(\lambda\) del modello di Poisson: \(\hat\lambda =  \frac 1n\sum_{i=1}^nx_i\)
  Scrivere la Varianza di \(\hat \lambda\).
\item
  (\textbf{Punti 3}) Se \(h\) è uno stimatore per \(\theta\) tale che
  \(E(h)\ne \theta\) e che \(\lim_ {n\to +\infty}V(h)=0\) di quale proprietà gode \(h\)?
\item
  (\textbf{Punti 3}) Definire gli errori di primo e di secondo
  tipo di un test statistico e le relative probabilità.
\item
  (\textbf{Punti 3}) In un confronto tra due campioni viene messo a test
  \[
  \begin{cases}
  H_0:\sigma_A=\sigma_B\\
  H_1:\sigma_A\ne \sigma_B
...
Siccome \(\chi^2_\text{obs}=70.954045954046>\chi^2_{2;0.001}=13.8155\), quindi \textbf{rifiuto} \(H_0\) sotto all'1‰, \(p_\text{value}<0.001\),

\emph{estremamente significativo} \(\fbox{***}\).

\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-316-1} \end{center}
...
\tightlist
\item
  (\textbf{Punti 14}) Calcolare il residuo del comune B nel modello di regressione dove \(Y\) viene spiegata da \(X\).
\end{enumerate}
...
\tightlist
\item
  (\textbf{Punti 3}) Scrivere la scomposizione della varianza del modello di regressione
  e calcolare la Total Sum of Squares (TSS), la Explained Sum of Squares (ESS) e la Residual Sum of Squares (RSS) dei dati analizzati sopra.
\end{enumerate}
...
\setcounter{enumi}{5}
\item
  (\textbf{Punti 3}) Interpretare il parametro di regressione \(\hat\beta_1\).
\item
  (\textbf{Punti 2}) Descrivere la differenza tra punti di leva e punti influenti.
\item
  (\textbf{Punti 2}) Gli stimatori \(\hat\beta_0\) e \(\hat\beta_1\) dei minimi
...
\tightlist
\item
  (\textbf{Punti 14}) Disegnare l'istogramma delle densità percentuali.
\end{enumerate}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-323-1} \end{center}
...
\tightlist
\item
  (\textbf{Punti 3}) Quante aziende hanno un bilancio compreso tra il 25-esimo
...
\tightlist
\item
  (\textbf{Punti 2}) Che relazione dobbiamo attenderci tra media, mediana e moda?
\end{enumerate}
...
\tightlist
\item
  (\textbf{Punti 2}) Siano \(x_1,...,x_n\), \(n\) numeri. Si consideri la funzione:
  \[g(x)=(x_1-x)^2+...+(x_n-x)^2.\]
  Per quale valore di \(x\), \(g(x)\) è minima?
\end{enumerate}
...
\tightlist
\item
  (\textbf{Punti 14}) Si consideri l'evento \(E\)=``più di due veicoli
...
\setcounter{enumi}{1}
\item
  (\textbf{Punti 2}) Siano \(X\sim N(0,1)\) e \(Y\sim N(0,1)\), \(X\) e \(Y\) indipendenti.
  Come si distribuisce \(X^2+Y^2\)?
\item
  (\textbf{Punti 2}) Se \(X\) è una VC con supporto \{2,3,4,5\} e \(Y\) è una VC con supporto
  \{1,2,6\}.
  Qual è il supporto di \(X-Y\)?
\end{enumerate}
...
\tightlist
\item
  (\textbf{Punti 3}) Siano \(h_1\) e \(h_2\) due stimatori per \(\theta\), tali che
\end{enumerate}
...
\setcounter{enumi}{3}
\item
  (\textbf{Punti 3}) Sia \(\hat\sigma^2\) lo stimatore di massima verosimiglianza
  di \(\sigma^2\). In virtù di quale proprietà \(\hat \sigma\) è lo stimatore di
  massima verosimiglianza per \(\sigma\)?
\item
  (\textbf{Punti 3}) Siano \(T_1\) e \(T_2\) due test per lo stesso sistema di ipotesi,
...
\item
  (\textbf{Punti 3}) Se in un test statistico bilaterale che utilizza
...
Siccome \(t_\text{obs}=-9.2469<t_{73-2;0.001}=-3.209\), quindi \textbf{rifiuto} \(H_0\) sotto all'1‰,
...
\tightlist
\item
  (\textbf{Punti 14}) Stimare la previsione per \(x=1.6\) nel modello di regressione dove \(Y\) viene spiegata da \(X\).
\end{enumerate}
...
\tightlist
\item
  (\textbf{Punti 3}) Calcolare numericamente \(RSS\):
  \[
...
\setcounter{enumi}{5}
\item
  (\textbf{Punti 3}) Gli stimatori \(\hat\beta_0\) e \(\hat\beta_1\) sono consistenti?
  Perché?
\item
  (\textbf{Punti 2}) Se in un modello di regressione con 11 dati,
  il residuo studentizzato del dato \(i\) è \(\tilde \epsilon_i=1.23\), cosa possiamo concludere?
\item
  (\textbf{Punti 2}) Sia \(\hat\beta_1\) lo stimatore dei minimi quadrati per \(\beta_1\).
...
\tightlist
\item
  (\textbf{Punti 14}) Calcolare il valore approssimato della mediana.
\end{enumerate}
...
\tightlist
\item
  (\textbf{Punti 3}) Quante aziende hanno un bilancio compreso tra \(-1\) e il 75-esimo
  percentile?
\end{enumerate}
...
\item
  (\textbf{Punti 2}) Che relazione dobbiamo attenderci tra media, mediana e moda?
\item
  (\textbf{Punti 2}) Sapendo che \(\sigma_X=2.82\) la Standard Deviation di \(X\)
...
\tightlist
\item
  (\textbf{Punti 14}) Qual è la probabilità di vincere?
\end{enumerate}
...
\tightlist
\item
  (\textbf{Punti 3}) Si ripete il gioco di sopra finché non si vince tre volte. Qual è la probabilità di finire alla quinta giocata?
\end{enumerate}
...
\tightlist
\item
  (\textbf{Punti 2}) Se \(X\) è una VC con supporto \{1,2,3\} e \(Y\) è una VC con
  supporto \{1,3,5\}.
  Qual è il supporto di \(X\times Y\)?
\end{enumerate}
...
\tightlist
\item
  (\textbf{Punti 3}) Sia \(h\) uno stimatore per \(\theta\), tale che
\end{enumerate}
...
\setcounter{enumi}{3}
\item
  (\textbf{Punti 3}) Sia \(\hat\theta\) lo stimatore di massima verosimiglianza
  per \(\theta\). Qual è la distribuzione asintotica di \(\hat\theta\)?
\item
  (\textbf{Punti 3}) Un intervallo di confidenza per \(\theta\) al 90\% è più ampio o meno ampio di uno al 95\%? Perché?
\item
  (\textbf{Punti 3}) Se in un test statistico bilaterale che utilizza la statistica test \emph{z} , risulta \(z_\text{obs}=14\), il \(p_\text{value}\) sarà maggiore o minore di 0.01? Perché?
\end{enumerate}
...
\tightlist
\item
  (\textbf{Punti 4}) Costruire un intervallo di confidenza la 95\% per \(\pi\) la quota di tassisti favorevoli al decreto liberalizzazione
\end{enumerate}
...
\tightlist
\item
  (\textbf{Punti 10}) La stessa domanda è stata posta ad un secondo
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-335-1} \end{center}
...
\tightlist
\item
  (\textbf{Punti 14}) Questi sono alcuni dei dati osservati
\end{enumerate}
...
\tightlist
\item
  (\textbf{Punti 3}) Calcolare la percentuale di varianza di \(Y\) spiegata dal modello.
\end{enumerate}
...
\setcounter{enumi}{5}
\item
  (\textbf{Punti 2}) Se in un modello di regressione con 15 dati,
  il residuo studentizzato del dato \(i\) è \(\tilde \epsilon_i=12.3\), cosa possiamo concludere?
\item
  (\textbf{Punti 2}) Sia \(\hat\beta_0\) lo stimatore dei minimi quadrati per \(\beta_0\).
...
Siccome \(t_{70-2;0.005}=2.6501<|t_\text{obs}|=2.5719<t_{70-2;0.025}=1.9955\), quindi \textbf{rifiuto} \(H_0\) al 5\%,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-352-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-356-1} \end{center}
...
5.a (\textbf{Punti 14}) In uno studio sul gradimento dell'azione politica della regione, nel comune \(A\) si è rilevato che 26 persone su 35 intervistati è soddisfatto, mentre nel comune \(B\), 45 su 50 sono soddisfatti.
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-361-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-369-1} \end{center}
...
5.b (\textbf{Punti 7}) Un'indagine analoga, svolta sull'intera regione, ha mostrato un gradimento medio pari a \(\mu_0=71\). Testare l'ipotesi che nel comune A il livello di gradimento sia uguale a quello regionale contro l'alternativa che sia \textbf{minore}.
...
Siccome \(t_\text{obs}=-3.4986<t_{35-1;0.001}=-3.3479\), quindi \textbf{rifiuto} \(H_0\) sotto all'1‰,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-374-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-378-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-382-1} \end{center}
...
Siccome \(\chi^2_{4;0.05}=9.4877<\chi^2_\text{obs}=8.36437246841533<\chi^2_{4;0.1}=7.7794\), indecisione sul rifiuto di \(H_0\) al 10\%, \(0.05<p_\text{value}<0.1\),

\emph{marginalmente significativo} \(\fbox{.}\).

\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-386-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-390-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-395-1} \end{center}
...
Siccome \(t_{37-2;0.01}=2.4377<t_\text{obs}=2.1192<t_{37-2;0.05}=1.6896\), quindi \textbf{rifiuto} \(H_0\) al 5\%,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-400-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-404-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-409-1} \end{center}
...
5.b (\textbf{Punti 7}) Un'indagine analoga, svolta sull'intera regione, ha mostrato un reddito medio pari a \(\mu_0=71\). Testare l'ipotesi che nel comune \(A\) il reddito medio sia uguale a quello regionale contro l'alternativa che sia \textbf{diverso}.
...
Siccome \(t_{35-1;0.0005}=3.6007<|t_\text{obs}|=3.4986<t_{35-1;0.005}=2.7284\), quindi \textbf{rifiuto} \(H_0\) all'1\%,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-414-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-418-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-422-1} \end{center}
...
5.c (\textbf{Punti 14}) Testare l'ipotesi che l'intercetta sia uguale a zero contro l'alternativa che sia diversa da zero.
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-429-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-443-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-447-1} \end{center}
...
5.b (\textbf{Punti 7}) Un'indagine analoga, svolta sull'intera regione, ha mostrato un gradimento medio pari a \(\mu_0=0.6\). Testare l'ipotesi che nel comune A il livello di gradimento sia uguale a quello regionale contro l'alternativa che sia minore.
...
Siccome \(t_{35-1;0.01}=-2.4411<t_\text{obs}=-2.3324<t_{35-1;0.05}=-1.6909\), quindi \textbf{rifiuto} \(H_0\) al 5\%,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-454-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-465-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-468-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-472-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-476-1} \end{center}
...
Siccome \(t_{49-2;0.005}=2.6846<|t_\text{obs}|=2.5565<t_{49-2;0.025}=2.0117\), quindi \textbf{rifiuto} \(H_0\) al 5\%,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-482-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-490-1} \end{center}
...
Siccome \(t_{25-1;0.01}=2.4922<t_\text{obs}=1.7958<t_{25-1;0.05}=1.7109\), quindi \textbf{rifiuto} \(H_0\) al 5\%,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-495-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-502-1} \end{center}
...
5.b (\textbf{Punti 10}) L'azienda afferma che la media delle spese mensili dei dipendenti è pari a \(1100€\). Effettuare un test di ipotesi per verificare se la media delle spese mensili sia superiore a \(1100€\).
...
Siccome \(t_\text{obs}=1<t_{10-1;0.1}=1.383\), quindi \textbf{non} rifiuto \(H_0\) a \textbf{nessun}
livello di significatività,

\(p_\text{value}>0.1\),
\emph{non significativo}

\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-510-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-517-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-525-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-532-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-539-1} \end{center}
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-546-1} \end{center}

\end{sol}

1.b (\textbf{Punti 3}) Quante famiglie spendono meno di 5 mila euro all'anno?
...
1.c (\textbf{Punti 2}) Che relazione dobbiamo aspettarci tra media, mediana e moda?

1.d (\textbf{Punti 2}) La spesa media è pari a \(\bar x=3.4838\), mentre la SD è pari a \(SD=3.9497\).
...
2.a (\textbf{Punti 14}) Si lancia una moneta perfetta 4 volte. Sia \(X\) la variabile casuale che conta il numero di Teste su 4 lanci. Calcolare la probabilità che \(X\leq 2\).
...
2.b (\textbf{Punti 3}) Sia lancia una seconda moneta perfetta 3 volte. Sia \(Y\) la variabile casuale che conta il numero di Teste su 3 lanci. Calcolare la probabilità che \(X+Y=3\).
...
2.c (\textbf{Punti 2}) Se \(P(A)=0.4\) e \(P(B)=0.8\), \(A\) e \(B\) possono essere incompatibili? Perché?
...
2.d (\textbf{Punti 2}) Cosa significa che la funzione di ripartizione è continua a destra?

\subsection{Esercizio 3}\label{esercizio-3-34}

(\textbf{Punti 14}) Un'urna 3 premi da \(\mbox{0}\) euro, 2 premi da \(\mbox{1}\) euro e un premio da \(\mbox{2}\) euro.
...
4.a (\textbf{Punti 3}) Si consideri il modello normale \(X\sim N(\mu,\sigma^2)\). Sia \(\hat\mu\) lo stimatore di massima verosimiglianza per \(\mu\)
...
4.b (\textbf{Punti 3}) Definire lo Standard Error di uno stimatore.
...
5.a (\textbf{Punti 14}) Si è osservato \(x_3=10\) e \(y_3=29\), stimare il modello di regressione dove \(Y\) viene spiegata da \(X\) e calcolare il residuo per il punto \(i=3\).
...
5.c (\textbf{Punti 2}) Definire i punti influenti.

5.d (\textbf{Punti 2}) Se in un modello di regressione \(r=-1\) cosa significa?

5.e (\textbf{Punti 2}) Se in un modello di regressione \(r=0.55\), \(\hat\sigma_X=0.9\) e \(\hat\beta_1=1.5\), quanto varrà
\(\hat\sigma_Y\), la standard deviation di \(Y\)?

5.f (\textbf{Punti 14}) Testare l'ipotesi che \(\beta_1\) sia uguale a zero, contro l'alternativa che sia diverso per diversi livelli di significatività e dare una valutazione approssimativa del \(p\)-value (ad esempio il \(p\)-value è minore di 0.001, compreso tra 0.05 e tra 0.01, ecc.).
...
Siccome \(|t_\text{obs}|=11.4008>t_{50-2;0.0005}=3.5051\), quindi \textbf{rifiuto} \(H_0\) sotto all'1‰,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-555-1} \end{center}
...
1.a (\textbf{Punti 14}) Individuare l'intervallo modale.
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-558-1} \end{center}

\end{sol}

1.b (\textbf{Punti 3}) Quante famiglie investono più di 4 mila euro all'anno?
...
1.d (\textbf{Punti 2}) La spesa media è pari a \(5.6714\), mentre la varianza è pari a \(19.5627\).
...
2.a (\textbf{Punti 14}) Sia \(X\) numero settimanale di pratiche inevase dall'ufficio provinciale, si assume \(X\sim\text{Pois}(3.5)\). Calcolare la probabilità che \(X\geq 3\).
...
2.b (\textbf{Punti 3}) Sia \(Y\) numero settimanale di pratiche inevase dall'ufficio comunale, si assume \(Y\sim\text{Pois}(2)\) e si assume \(X\) indipendente da \(Y\). Calcolare la probabilità che \(X+Y=5\).
...
2.c (\textbf{Punti 2}) Se \(P(A)=0.4\) e \(P(B)=0.4\), \(A\) e \(B\) possono essere incompatibili? Perché?

2.d (\textbf{Punti 2}) Sia \(X\) una variabile casuale e sia \(F\) la sa funzione di ripartizione. Siano \(a\) e \(b\) due numeri reali, \(a<b\), esprimere
\[
P(a<X\leq b)
\]
in termini di \(F\).
...
(\textbf{Punti 14}) Un'urna 4 premi da \(\mbox{0}\) euro, 3 premi da \(\mbox{1}\) euro e 2 premi da \(\mbox{2}\) euro.
Si estrae 50 volte con reintroduzione.
...
4.a (\textbf{Punti 3}) Si consideri il modello di Bernoulli \(X\sim\text{Ber}(\pi)\). Sia \(\hat\pi\) lo stimatore di massima verosimiglianza per \(\pi\)
...
5.a (\textbf{Punti 14}) Si è osservato \(x_3=13\) e \(y_3=40\), stimare il modello di regressione dove \(Y\) viene spiegata da \(X\) e calcolare il residuo per il punto \(i=3\).
...
5.b (\textbf{Punti 3}) Il modello si adatta bene ai dati?
...
5.c (\textbf{Punti 2}) Definire i punti di leva.

5.d (\textbf{Punti 2}) Se in un modello di regressione \(r=+1\) cosa significa?

5.e (\textbf{Punti 2}) Se in un modello di regressione \(r<0\) è possibile che \(\hat\beta_1>0\)? Perché?

5.f (\textbf{Punti 14}) Testare l'ipotesi che \(\beta_0\) sia uguale a 35, contro l'alternativa che sia minore per diversi livelli di significatività e dare una valutazione approssimativa del \(p\)-value (ad esempio il \(p\)-value è minore di 0.0005, compreso tra 0.05 e 0.01, ecc.).
...
Siccome \(t_{50-2;0.001}=-3.2689<t_\text{obs}=-2.7708<t_{50-2;0.01}=-2.4066\), quindi \textbf{rifiuto} \(H_0\) all'1\%,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-568-1} \end{center}

Il \(p_{\text{value}}\) è

\[ p_{\text{value}} = P(T_{50-2}<-2.77)=0.003965 \]

Attenzione il calcolo del \(p_\text{value}\) con la \(T\) è puramente illustrativo e non può essere riprodotto senza una calcolatrice statistica adeguata.\[
 0.001 < p_\text{value}= 0.003965 \leq 0.01 
\]
...
1.a (\textbf{Punti 14}) Calcolare il valore approssimativo della mediana.
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-571-1} \end{center}

\end{sol}

1.b (\textbf{Punti 3}) Quante famiglie spendono tra 4 mila e 10 mila euro l'anno?
...
1.d (\textbf{Punti 2}) La spesa media è pari a \(4.9551\), mentre la varianza è pari a \(19.0807\).
...
2.a (\textbf{Punti 14}) Sia \(X\sim N(5,2)\) sia \(A=\{X>4\}\) e \(B=\{X<6\}\). Calcolare \(P(A\cap B)\).
...
2.b (\textbf{Punti 3}) Sia \(Y\sim N(3,1)\), \(X\) e \(Y\) indipendenti, posto \(W=X-Y\), calcolare \(P(W<0)\).
...
2.c (\textbf{Punti 2}) Se \(P(A)=0.4\) e \(P(B)=0.6\), in che relazione sono \(A\) e \(B\)?

2.d (\textbf{Punti 2}) Sia \(X\) una variabile casuale e sia \(F\) la sua funzione di ripartizione. Cosa significa che \(F\) è una funzione crescente?

\subsection{Esercizio 3}\label{esercizio-3-36}

(\textbf{Punti 14}) Un'urna 4 premi da \(\mbox{0}\) euro, 2 premi da \(\mbox{1}\) euro.
Si estrae 50 volte con reintroduzione.
...
4.a (\textbf{Punti 3}) Si consideri il modello binomiale \(X\sim\text{Pois}(\lambda)\). Sia \(\hat\lambda\) lo stimatore di massima verosimiglianza per \(\mu\)
...
4.b (\textbf{Punti 3}) Che differenza c'è tra lo Standard Error di uno stimatore e la Deviazione Standard di popolazione?

4.c (\textbf{Punti 3}) Definire gli errori di primo e di secondo tipo.

4.d (\textbf{Punti 3}) Un biologo sta studiando il numero di cellule di una certa specie osservate in campioni di terreno. Ha raccolto dati sul numero di cellule in 45 campioni. I dati osservati sono riportati nella tabella seguente. L'obiettivo è determinare se i dati seguono una distribuzione di Poisson.

\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-577}Numero di cellule osservate nei campioni di terreno}
\centering
...
5.a (\textbf{Punti 12}) In un'indagine sull'opinione sul reddito di inclusione sono stati intervistate 150 persone che vivono al nord e 180 che vivono al sud: 60 su 150 che vivono al nord sono favorevoli al reddito di cittadinanza mentre 95 su 180 che vivono al sud sono favorevoli.
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-578-1} \end{center}
...
6.a (\textbf{Punti 14}) Si è osservato \(x_3=19\) e \(y_3=21\), stimare il modello di regressione dove \(Y\) viene spiegata da \(X\) e calcolare il residuo per il punto \(i=3\).
...
6.b (\textbf{Punti 3}) Dare un'interpretazione dei parametri di regressione stimati.

6.c (\textbf{Punti 2}) Definire gli outliers.

6.d (\textbf{Punti 2}) Se in un modello di regressione \(r=0\) cosa significa?

6.e (\textbf{Punti 2}) Se in un modello di regressione \(r=0.55\), \(\hat\sigma_Y=0.9\) e \(\hat\beta_1=1.5\), quanto varrà
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-583-1} \end{center}
...
1.d (\textbf{Punti 2}) La spesa media è pari a \(\bar x=3.5222\), mentre la SD è pari a \(SD=4.2267\).
Se ogni famiglia spendesse 2 mila euro in più all'anno, quanto varrebbero la media e la SD dei dati trasformati?

\subsection{Esercizio 2}\label{esercizio-2-38}

2.a (\textbf{Punti 14}) Si consideri un'urna che ha una pallina bianche e due nere. Si estrae 4 volte con reinserimento. Sia \(X\) la variabile casuale che conta il numero di bianche su 4 estrazioni. Calcolare la probabilità che \(X\leq 2\).
...
2.b (\textbf{Punti 3}) Sia \(X\) la VC del punto precedente e sia \(Y\sim N(0,1)\), \(X\) ed \(Y\) indipendenti. Considerato \(A=\{X\leq 2\}\), \(B=\{Y<1\}\), calcolare \(P(A\cup B)\).
...
2.c (\textbf{Punti 2}) Se \(A\) e \(B\), sono due eventi tali che \(P(B|A)=1\), determinare \(A\cap B\).
...
2.d (\textbf{Punti 2}) Sia \(X\) una Bernoulli di parametro \(\pi\), \(X\sim\text{Ber}(\pi)\) e sia \(F\) la sua funzione di ripartizione. Se \(F(0)=0.6\), quanto vale \(\pi\)?

\subsection{Esercizio 3}\label{esercizio-3-37}

(\textbf{Punti 14}) Un'urna contiene 6 premi da \(\mbox{0}\) euro, 3 premi da \(\mbox{1}\) euro e un premio da \(\mbox{2}\) euro.
Si estrae 100 volte con reintroduzione.
...
5.a (\textbf{Punti 14}) Si è osservato \(x_3=4.14\) e \(y_3=3.79\), stimare il modello di regressione dove \(Y\) viene spiegata da \(X\) e calcolare il residuo per il punto \(i=3\).
...
\begin{sol}
\begin{eqnarray*}
r&=&\frac{\text{cov}(X,Y)}{\sigma_X\sigma_Y}=\frac{ 5.136 }{ 5.765 \times 2.126 }= 0.4191 \\r^2&=& 0.1756 < 0.75
\end{eqnarray*}
Il modello \textbf{non} si adatta bene ai dati.

\end{sol}

5.c (\textbf{Punti 2}) perché la previsione per \(x=8\) è più affidabile di quella per \(x=81\).

5.d (\textbf{Punti 2}) Se in un modello di regressione \(r=-1\) cosa significa?

5.e (\textbf{Punti 2}) Se in un modello di regressione \(r=0.75\), \(\hat\sigma_X=0.8\) e \(\hat\beta_1=1.2\), calcolare
...
5.f (\textbf{Punti 14}) Testare l'ipotesi che \(\beta_1\) sia uguale a zero, contro l'alternativa che sia diverso per \(\alpha=0.1,0.05,0.01,0.001\) e dare una valutazione approssimativa del \(p_\text{value}\) (ad esempio il \(p_\text{value}\) è minore di 0.001, compreso tra 0.05 e tra 0.01, ecc.).
...
Siccome \(t_{25-2;0.005}=2.8073<|t_\text{obs}|=2.2071<t_{25-2;0.025}=2.0687\), quindi \textbf{rifiuto} \(H_0\) al 5\%,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-595-1} \end{center}

Il \(p_{\text{value}}\) è

\[ p_{\text{value}} = P(|T_{25-2}|>|2.21|)=2P(T_{25-2}>2.21)=0.037555 \]

Attenzione il calcolo del \(p_\text{value}\) con la \(T\) è puramente illustrativo e non può essere riprodotto senza una calcolatrice statistica adeguata.\[
 0.01 < p_\text{value}= 0.037555 \leq 0.05 
\]
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-598-1} \end{center}

\end{sol}

1.b (\textbf{Punti 3}) Quante famiglie spendono più del 25-esimo percentile \(x_{0.25}\)?
...
1.c (\textbf{Punti 2}) La media è pari a \(\bar x=4.49\), senza disegnare l'istogramma, che forma distributiva dobbiamo aspettarci?

1.d (\textbf{Punti 2}) La spesa media della regione Emilia-Romagna, calcolata su 160 famiglie è pari \(\bar x_{ER}=4.49\), quella della Lombardia, calcolata su 180 famiglie è pari \(\bar x_{L}=4.56\), mentre quella del Veneto, calcolata su 150 famiglie è pari \(\bar x_{V}=3.79\). Qual è la spesa media complessiva delle tre regioni?
...
&=& \frac{160\cdot4.49+180\cdot4.56+150\cdot3.79}{160+180+150}\\
&=& 4.3
\end{eqnarray}
...
2.a (\textbf{Punti 14}) Sia \(X\) il numero di telefonate in arrivo ad un centralino di emergenza, si assume \(X\sim\text{Pois}(1.2)\). Calcolare la probabilità che \(X\geq 2\).
...
2.b (\textbf{Punti 3}) Siano \(X\sim\text{Pois}(1.2)\) e \(Y\sim\text{Binom}(n=2,\pi=0.5)\), \(X\) e \(Y\) indipendenti, posto \(A=\{X\geq 2\}\), \(B=\{Y=0\}\), calcolare \(P(A\cup B)\).
...
2.c (\textbf{Punti 2}) Se \(A\) e \(B\) sono due eventi diversi da \(\emptyset\), se
\(P(A|B)=0\) in che relazione sono \(A\) e \(B\)?

2.d (\textbf{Punti 2}) Sia \(X\) una variabile casuale con supporto \(S_X=c\{-1,0,2\}\) e con funzione di probabilità
\[
f(x)=\begin{cases}
\frac 25, &\text{ se $x=-1$}\\
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-603-1} \end{center}

\end{sol}

\subsection{Esercizio 3}\label{esercizio-3-38}

(\textbf{Punti 14}) Un'urna 4 premi da \(\mbox{0}\) euro, 1 premio da \(\mbox{2}\) euro.
Si estrae 50 volte con reintroduzione.
...
4.b (\textbf{Punti 3}) Cosa significa che lo stimatore di massima verosimiglianza è invariante alle trasformazioni monotone invertibili?

4.c (\textbf{Punti 3}) Siano \(T_1\) e \(T_2\) due test per lo stesso sistema di ipotesi con la stessa significatività \(\alpha\), sia \(\beta_1=0.23\) la probabilità di errore di secondo tipo del test \(T_1\) e \(\beta_2=0.18\) la probabilità di errore di secondo tipo del test \(T_2\). Quale dei due test è più potente?

4.d (\textbf{Punti 3}) In un'indagine sull'opinione sul reddito di inclusione sono stati intervistate 150 persone che vivono al nord e 180 che vivono al sud: 60 su 150 che vivono al nord sono favorevoli al reddito di cittadinanza mentre 95 su 180 che vivono al sud sono favorevoli.
Messo a test
...
5.a (\textbf{Punti 14}) Si è osservato \(x_3=10\) e \(y_3=8.2031\), stimare il modello di regressione dove \(Y\) viene spiegata da \(X\) e calcolare il residuo per il punto \(i=3\).
...
\begin{sol}
\begin{eqnarray*}
r&=&\frac{\text{cov}(X,Y)}{\sigma_X\sigma_Y}=\frac{ -11.42 }{ 3.901 \times 3.07 }= -0.9537 \\r^2&=& 0.9095 > 0.75
\end{eqnarray*}
Il modello si adatta bene ai dati.

\end{sol}

5.c (\textbf{Punti 2}) Interpretare il diagramma dei residui.

\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-608-1} \end{center}

5.d (\textbf{Punti 2}) Se in un modello di regressione \(r^2=1\) cosa significa?

5.e (\textbf{Punti 2}) Se in un modello di regressione \(r<0\) che segno avrà \(\hat\beta_1\)? Perché?

5.f (\textbf{Punti 14}) Testare l'ipotesi che \(\beta_0\) sia uguale a 16.4, contro l'alternativa che sia minore per \(\alpha=0.1,0.05,0.01,0.001\) e dare una valutazione approssimativa del \(p_\text{value}\) (ad esempio il \(p_\text{value}\) è minore di 0.001, compreso tra 0.05 e tra 0.01, ecc.).
...
Siccome \(t_\text{obs}=-0.4183>t_{50-2;0.1}=-1.2994\), quindi \textbf{non} rifiuto \(H_0\) a \textbf{nessun}
livello di significatività,

\(p_\text{value}>0.1\),
\emph{non significativo}

\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-609-1} \end{center}

Il \(p_{\text{value}}\) è

\[ p_{\text{value}} = P(T_{50-2}<-0.42)=0.338810 \]

Attenzione il calcolo del \(p_\text{value}\) con la \(T\) è puramente illustrativo e non può essere riprodotto senza una calcolatrice statistica adeguata.\[
 0.1 < p_\text{value}= 0.338810 \leq 1 
\]
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-612-1} \end{center}

\end{sol}

1.b (\textbf{Punti 3}) Qual è la percentuale di famiglie spendono più del 55-esimo percentile \(x_{0.55}\)?
...
1.c (\textbf{Punti 2}) La media è pari a \(\bar x=4\), senza disegnare l'istogramma, che forma distributiva dobbiamo aspettarci?

1.d (\textbf{Punti 2}) La spesa media è pari a \(4.0009\), mentre la varianza è pari a \(10.6517\).
Se ogni famiglia diminuisse la propria spesa del 2\%, quanto varrebbero la media e la varianza dei dati così trasformati?
...
2.a (\textbf{Punti 14}) Sia \(X\sim N(6,0.5)\) e sia \(Y\sim N(6,0.5)\), \(X\) e \(Y\) indipendenti sia \(A=\{X>5\}\) e \(B=\{Y<7\}\).
Calcolare \(P(A\cup B)\).
...
2.b (\textbf{Punti 3}) , posto \(W=X-Y\), calcolare \(P(W<1|W>-1)\).
...
2.c (\textbf{Punti 2}) Se \(P(A)=0.4\) e \(P(B)=0.7\), è possibile che \(A\cap B=\emptyset\)? Perché?
...
2.d (\textbf{Punti 2}) Sia \(X\sim\text{Binom}(n=2,\pi=0.5)\) e sia \(F\) la sua funzione di ripartizione. Disegnare \(F(x)\) nell'intervallo \(-1\leq x\leq 3\)
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-616-1} \end{center}

\end{sol}

\subsection{Esercizio 3}\label{esercizio-3-39}

(\textbf{Punti 14}) Un'urna 3 premi da \(\mbox{0}\) euro, un premio da \(\mbox{1}\) euro.
Si estrae 100 volte con reintroduzione.
...
4.d (\textbf{Punti 3}) Un economista sta studiando il numero di piccole imprese che aprono ogni mese in una certa regione. Ha raccolto dati sul numero di nuove imprese in 57 mesi. I dati osservati sono riportati nella tabella seguente. L'obiettivo è determinare se i dati seguono una distribuzione di Poisson.

\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-619}Numero di nuove piccole imprese settimanale.}
\centering
...
5.a (\textbf{Punti 14}) In un'indagine sui consumi in beni alimentari sono stati intervistati 13 nuclei familiari al Nord d'Italia e 15 al Sud.
...
Siccome \(t_{39-2;0.001}=3.3256<t_\text{obs}=3.0406<t_{39-2;0.01}=2.4314\), quindi \textbf{rifiuto} \(H_0\) all'1\%,
...
\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/unnamed-chunk-621-1} \end{center}
...
6.a (\textbf{Punti 14}) Si è osservato \(x_3=1.66\) e \(y_3=7.0072\), stimare il modello di regressione dove \(Y\) viene spiegata da \(X\) e calcolare il residuo per il punto \(i=3\).
...
6.c (\textbf{Punti 2}) Definire i punti di leva e indicare una misura per misurarli.

6.d (\textbf{Punti 2}) Se in un modello di regressione \(r^2=0\) cosa significa?

6.e (\textbf{Punti 2}) Se in un modello di regressione \(r=0.55\), \(\hat\sigma_Y=0.9\) e \(\hat\beta_1=1.5\), calcolare
\(\hat\alpha_1\), la stima del coefficiente angolare del modello
