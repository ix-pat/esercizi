...
b.   calcolare il valore approssimato del percentile  $25$-esimo, e tracciarlo nell'istogramma.
...
1.d  Si estrae **2 volte SENZA REINTRODUZONE** calcolare la probabilità di avere
una bianca e una nera, non importa l'ordine.
...
1.b  si estrae 3 volte __senza__ reintroduzione.
Calcolare la probabilità di aver 3 colori diversi.
...
1.b  Calcolare la probabilità che dall'urna $A$ sia uscito $\mbox{+1}$, __dato__ che
la somma fa 1
...
1.a  Si estrae $n=2$ volte __senza__ reintroduzione. Qual è la probabilità di ottenere due colori diversi in 2 estrazioni? (esempio: prima bianco poi rosso _oppure_ prima nero poi bianco oppure...)  
...
<!-- 1.g  Ottenuto $X=2$ costruire la probabilità aggiornata di  -->
...
**Teorema del Limite Centrale (somma VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=64$ VC IID, tc $E(X_i)=\mu=2$ e $V(X_i)=\sigma^2=0.1,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
...
**Teorema del Limite Centrale (somma VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=100$ VC IID, tc $E(X_i)=\mu=2$ e $V(X_i)=\sigma^2=4.4,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
**Teorema del Limite Centrale (somma VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=81$ VC IID, tc $E(X_i)=\mu=1$ e $V(X_i)=\sigma^2=1.778,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
**Teorema del Limite Centrale (media VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=92$ VC IID, tc $E(X_i)=\mu=1.25$ e $V(X_i)=\sigma^2=1.438,\forall i$, posto:
      \[
      \bar X=\frac{S_n}n =\frac{X_1 + ... + X_n}n
      \]
      allora:\begin{eqnarray*}
...
**Teorema del Limite Centrale (proporzione)** 
 ...
 Siano $X_1$,...,$X_n$, $n=81$ VC IID, tc $X_i\sim\text{Ber}(\pi=0.6)$$,\forall i$, posto:
      \[
...
**Teorema del Limite Centrale (proporzione)** 
 ...
 Siano $X_1$,...,$X_n$, $n=81$ VC IID, tc $X_i\sim\text{Ber}(\pi=0.6667)$$,\forall i$, posto:
      \[
      \hat\pi=\frac{S_n}n = \frac{X_1 + ... + X_n}n
      \]
      allora:\begin{eqnarray*}
...
**Teorema del Limite Centrale (somma di Poisson)** 
 ...
 Siano $X_1$,...,$X_n$, $n=52$ VC IID, tc $X_i\sim\text{Pois}(\lambda=1.5)$$,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
**Teorema del Limite Centrale (somma di Poisson)** 
 ...
 Siano $X_1$,...,$X_n$, $n=49$ VC IID, tc $X_i\sim\text{Pois}(\lambda=1.5)$$,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
**Teorema del Limite Centrale (somma di Poisson)** 
 ...
 Siano $X_1$,...,$X_n$, $n=52$ VC IID, tc $X_i\sim\text{Pois}(\lambda=2.3)$$,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
**Teorema del Limite Centrale (proporzione)** 
 ...
 Siano $X_1$,...,$X_n$, $n=80$ VC IID, tc $X_i\sim\text{Ber}(\pi=0.6065)$$,\forall i$, posto:
      \[
      \hat\pi=\frac{S_n}n = \frac{X_1 + ... + X_n}n
      \]
      allora:\begin{eqnarray*}
...
7.1  Su un campione di \( n = 100 \) abitanti del quartiere _R_ è stato chiesto se siano favorevoli o meno all'introduzione di una nuova pista ciclabile. Lo studio ha riportato che 70 persone su 100 (il 70% del campione) è favorevole.
...
1.c **(Punti 2/100 $\rightarrow$ 0.62/31)** L'utile medio è pari a $\bar x=2.1489$, e la sua standard deviation
...
2.b **(Punti 3/100 $\rightarrow$ 0.93/31)** Qual è la probabilità di avere esattamente _due_ casse su _quattro_ senza fila?
...
2.c **(Punti 3/100 $\rightarrow$ 0.93/31)** Quando due eventi $A$ e $B$ si dicono _indipendenti_ e quando _incompatibili_?
...
2.d **(Punti 2/100 $\rightarrow$ 0.62/31)** Se $X_1\sim N(2,1)$, $X_2\sim N(1,1)$ e $X_3\sim N(1,1)$, 
  $X_1$, $X_2$ e $X_3$ indipendenti, come si distribuisce 
...
**Teorema del Limite Centrale (somma di Bernoulli)** 
 ...
 Siano $X_1$,...,$X_n$, $n=60$ VC IID, tc $X_i\sim\text{Ber}(\pi=0.3333)$$,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
4.a **(Punti 3/100 $\rightarrow$ 0.93/31)** Sia $h$ uno stimatore per theta, tale che
$$
...
4.b **(Punti 3/100 $\rightarrow$ 0.93/31)** Siano $h_1$ e $h_2$ due stimatori per $\theta$, tali che:
\begin{eqnarray*}
MSE(h_1) &=&   \frac\theta n\\
...
4.c **(Punti 3/100 $\rightarrow$ 0.93/31)** Si sono osservati due gruppi di dati quantitativi e si è osservato, $\hat\mu_1=10.2$ e $\hat\mu_2=15.6$. Posto a test
$$
\begin{cases}
H_0:\mu_1=\mu_2\\
H_1:\mu_1\ne \mu_2
...
:::
  ...
  6.c **(Punti 3/100 $\rightarrow$ 0.93/31)** Discutere il qq-plot dei residui
...
X_L=X_E-X_U.
$$
2.a **(Punti 14/100 $\rightarrow$ 4.34/31)** Calcolare la probabilità che la variazione di livello sia negativa ($X_L<0$).
...
2.b **(Punti 3/100 $\rightarrow$ 0.93/31)** Nell'ipotesi di indipendenza tra i giorni, calcolare la probabilità di avere esattamente _due_ giorni su _cinque_ con livello negativo.  
...
2.d **(Punti 2/100 $\rightarrow$ 0.62/31)** Se $X\sim N(\mu_X,\sigma^2_X)$ come si distribuisce 
...
**Teorema del Limite Centrale (media VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=60$ VC IID, tc $E(X_i)=\mu=0$ e $V(X_i)=\sigma^2=0.7273,\forall i$, posto:
      \[
      \bar X=\frac{S_n}n =\frac{X_1 + ... + X_n}n
      \]
      allora:\begin{eqnarray*}
...
4.a **(Punti 3/100 $\rightarrow$ 0.93/31)** Sia $h$ uno stimatore per $\theta$, tale che
$$
...
4.b **(Punti 3/100 $\rightarrow$ 0.93/31)** Siano $X_1,...,X_n$ $n$ VC IID, replicazioni di $X\sim \mathscr{L}(\theta)$ e sia $\hat\theta$ lo stimatore di massima verosimiglianza per $\theta$, 
$\hat\theta$ è corretto?
...
Si consideri il modello di regressione dove $Y$ viene spiegata da $X$
  ...
  6.a **(Punti 14/100 $\rightarrow$ 4.34/31)** Si osservino le prime 5 coppie di dati
\begin{table}[H]
\centering
\begin{tabular}{rrr}
\toprule
...
:::
  ...
  6.c **(Punti 3/100 $\rightarrow$ 0.93/31)** Discutere il diagramma dei residui
...
1.b **(Punti 3/101 $\rightarrow$ 0.92/31)** Calcolare la percentuale approssimata di aziende 
...
1.c **(Punti 3/101 $\rightarrow$ 0.92/31)** Calcolare la percentuale approssimata di aziende 
con spese maggiori di 10 mila euro.
...
2.c **(Punti 3/101 $\rightarrow$ 0.92/31)** Sia $X\sim \text{Pois}(10)$ e $Y\sim\text{Binom}(n,0.5)$.
Sia
$$
W=X-Y
$$
...
2.d **(Punti 2/101 $\rightarrow$ 0.61/31)** Siano $X_1,...,X_6$, $6$ variabili casuali IID,
tali che
$$
...
3.a **(Punti 14/101 $\rightarrow$ 4.3/31)** Si lancia un dado perfetto, si vince se esce un numero maggiore o uguale a 5.
...
**Teorema del Limite Centrale (somma di Bernoulli)** 
 ...
 Siano $X_1$,...,$X_n$, $n=64$ VC IID, tc $X_i\sim\text{Ber}(\pi=0.3333)$$,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
4.c **(Punti 3/101 $\rightarrow$ 0.92/31)** Si sono osservati due gruppi di dati quantitativi e si è osservato, $\hat\mu_1=10.2$, $\hat\sigma_1=1.12$ e $\hat\mu_2=15.6$, $\hat\sigma_2=3.72$. Posto a test
$$
\begin{cases}
H_0:\sigma_1=\sigma_2\\
H_1:\sigma_1\ne \sigma_2
...
5.a **(Punti 14/101 $\rightarrow$ 4.3/31)** In uno studio sui consumi sono stati intervistati $n=25$ individui 
...
Si consideri il modello di regressione dove $Y$ viene spiegata da $X$
  ...
  6.a **(Punti 14/101 $\rightarrow$ 4.3/31)** Prevedere il consumo per un individuo che guadagna $x=4.126$ e
...
:::
  ...
  6.b **(Punti 3/101 $\rightarrow$ 0.92/31)** Quale delle due previsioni, per $x=4.126$ e per $x=12.3$,
...
2.c **(Punti 3/100 $\rightarrow$ 0.93/31)** Se $A$ e $B$ sono due eventi tali che, $P(A)>0$, $P(B)>0$, $P(A\cap B)=0$. 
...
2.d **(Punti 2/100 $\rightarrow$ 0.62/31)** Sia $X\sim N(3.2,(1.1)^2)$ e sia $Y\sim\chi_{n-1}^2$, posto
$$
...
3.a **(Punti 14/100 $\rightarrow$ 4.34/31)** Un'urna contiene un numero imprecisato di palline numerate. Si conoscono solo
...
**Teorema del Limite Centrale (media VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=81$ VC IID, tc $E(X_i)=\mu=12.3$ e $V(X_i)=\sigma^2=1.21,\forall i$, posto:
      \[
      \bar X=\frac{S_n}n =\frac{X_1 + ... + X_n}n
      \]
      allora:\begin{eqnarray*}
...
5.a **(Punti 14/100 $\rightarrow$ 4.34/31)** In uno studio sulle preferenze tra canali televisivi, vengono analizzati 92
...
$$
Il modello si adatta molto bene ai dati, spiegando il 234.6686% (>75%) della variabilità totale della Y. 
:::
...
6.d **(Punti 2/100 $\rightarrow$ 0.62/31)** Cosa significa che gli stimatori di massima dei minimi quadrati $\hat\beta_0$ e $\hat\beta_1$ sono _BLUE_?
...
2.c **(Punti 3/100 $\rightarrow$ 0.93/31)** Siano $X_1,...,X_n$, $n$ VC IID, tali che
$$
X_i\sim N(0,1).
$$
Posto
...
2.d **(Punti 2/100 $\rightarrow$ 0.62/31)** Siano $X_1\sim \text{Binom}(5,0.3)$ e $X_2\sim \text{Binom}(3,0.3)$.
Come si distribuisce,
$$X_1+X_2\sim ~~?$$
...
3.a **(Punti 14/100 $\rightarrow$ 4.34/31)** Un'urna contiene 4 palline numerate
...
**Teorema del Limite Centrale (media VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=64$ VC IID, tc $E(X_i)=\mu=1$ e $V(X_i)=\sigma^2=2.5,\forall i$, posto:
      \[
      \bar X=\frac{S_n}n =\frac{X_1 + ... + X_n}n
      \]
      allora:\begin{eqnarray*}
...
4.a **(Punti 3/100 $\rightarrow$ 0.93/31)** Se $h$ è uno stimatore tale che la sua distorsione va a zero per $n$ che tende all'infinito:
$$
...
4.c **(Punti 3/100 $\rightarrow$ 0.93/31)** Un dado, che non sappiamo se è perfetto oppure no, viene lanciato 40 volte.
...
5.b **(Punti 11/100 $\rightarrow$ 3.41/31)** È ben noto, da studi pregressi, che quella tipologia di farmaci ha un tempo medio 
...
:::
  ...
  6.c **(Punti 3/100 $\rightarrow$ 0.93/31)** Discutere il diagramma dei residui del modello di regressione dove $Y$ viene spiegata da $X$.
...
2.d **(Punti 2/100 $\rightarrow$ 0.62/31)** Siano $Y_1,...,Y_n$, $n$ VA IID, tali che, $Y_i\sim\chi_{1}^2$, posto
$$
X=\sum_{i=1}^n Y_i
$$
...
**Teorema del Limite Centrale (somma VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=81$ VC IID, tc $E(X_i)=\mu=0$ e $V(X_i)=\sigma^2=0.5333,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
4.c **(Punti 3/100 $\rightarrow$ 0.93/31)** In uno studio clinico si è osservato l'effeto sul numero di anticorpi su due gruppi trattati con un farmaco differente. Si è osservato $\hat\mu_1=10.2$, $\hat\sigma_1=1.12$ e $\hat\mu_2=15.6$, $\hat\sigma_2=3.72$. Posto a test
$$
\begin{cases}
H_0:\sigma_1=\sigma_2\\
H_1:\sigma_1\ne \sigma_2
...
5.b **(Punti 11/100 $\rightarrow$ 3.41/31)** È noto che quella fascia di motori ha un consuo medio pari $23.9~\text{Km/litro}$. Testare che il nuovo motore consumi come gli altri contro l'alternativa che abbia consumi _diversi_.
...
6.c **(Punti 3/100 $\rightarrow$ 0.93/31)** Considerata la scomposizine della TSS di $X$ rispetto ad $Y$.
$$
TSS = ESS + RSS
$$
...
2.c **(Punti 3/106 $\rightarrow$ 0.88/31)** Siano $X_1,...,X_n$, $n$ VC IID, tali che $X_i\sim \text{Ber}(\pi)$, posto
\[
 X = X_1+...+X_n
\]
come si distribuisce $X$? 
...
3.b **(Punti 14/106 $\rightarrow$ 4.09/31)** Il numero di incidenti giornalieri sul lavoro del comparto $A$ è distribuito come una
...
**Teorema del Limite Centrale (somma VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=365$ VC IID, tc $E(X_i)=\mu=36.5$ e $V(X_i)=\sigma^2=36.5,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
4.c **(Punti 3/106 $\rightarrow$ 0.88/31)** Una moneta, che non sappiamo se è perfetta oppure no, viene lanciata 40 volte.
...
4.d **(Punti 3/106 $\rightarrow$ 0.88/31)** In caso di campionamento casuale semplice **senza reintroduzione**
...
5.a **(Punti 3/106 $\rightarrow$ 0.88/31)** Determinare un intervallo di confidenza al 95%
...
5.b **(Punti 11/106 $\rightarrow$ 3.22/31)** Una indagine più vasta dell'anno precedente
...
1.d **(Punti 2/101 $\rightarrow$ 0.61/31)** La spesa media è pari a $\bar x=7.1245$, mentre la SD è pari a $SD=4.7792$.
...
2.c **(Punti 2/101 $\rightarrow$ 0.61/31)** Se $F$ è la funzione di ripartizione della VA $X$, posto $a < b$ due numeri qualunque, a cosa equivale
$$
F(b)-F(a) \qquad?
$$
...
**Teorema del Limite Centrale (somma VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=300$ VC IID, tc $E(X_i)=\mu=10$ e $V(X_i)=\sigma^2=0.09,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
4.a **(Punti 3/101 $\rightarrow$ 0.92/31)** Sia $\hat \lambda$ lo stimatore di massima verosimiglianza di $\lambda$ del modello di Poisson.
\begin{eqnarray*}
...
4.b **(Punti 3/101 $\rightarrow$ 0.92/31)** Definire lo _Standard Error_ di uno stimatore.
...
5.a **(Punti 14/101 $\rightarrow$ 4.3/31)** Il Supermercato $S$, della catena $C$, ha monitorato gli accessi al suo interno per una settimana.
...
1.d **(Punti 2/101 $\rightarrow$ 0.61/31)** La varianza della spesa è pari a $Var=18.3466$.
...
**Teorema del Limite Centrale (proporzione)** 
 ...
 Siano $X_1$,...,$X_n$, $n=100$ VC IID, tc $X_i\sim\text{Ber}(\pi=0.1667)$$,\forall i$, posto:
      \[
      \hat\pi=\frac{S_n}n = \frac{X_1 + ... + X_n}n
      \]
      allora:\begin{eqnarray*}
...
4.a **(Punti 3/101 $\rightarrow$ 0.92/31)** Sia $\hat \mu$ lo stimatore di massima verosimiglianza di $\mu$ del modello Normale.
\begin{eqnarray*}
...
6.c **(Punti 2/101 $\rightarrow$ 0.61/31)** Cosa sono i _punti di leva_ e cosa gli _outliers_?

6.d **(Punti 2/101 $\rightarrow$ 0.61/31)** Se $W=10\times Y$, posto
...
1.d **(Punti 2/101 $\rightarrow$ 0.61/31)** La varianza della spesa è pari a $Var=19.055$.
...
3.a **(Punti 14/101 $\rightarrow$ 4.3/31)** Un'urna contiene 3 palline bianche, 2 nere e 5 blu. Si estrae 200 volte con reimmissione.
...
**Teorema del Limite Centrale (somma di Bernoulli)** 
 ...
 Siano $X_1$,...,$X_n$, $n=200$ VC IID, tc $X_i\sim\text{Ber}(\pi=0.2)$$,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
4.a **(Punti 3/101 $\rightarrow$ 0.92/31)** Sia $\hat \lambda$ lo stimatore di massima verosimiglianza di $\lambda$ del modello Poisson.
\begin{eqnarray*}
  \hat\lambda &=&  \frac 1n\sum_{i=1}^nx_i\\
\end{eqnarray*}
...
5.a **(Punti 14/101 $\rightarrow$ 4.3/31)** In un'indagine sull'opinione sul reddito sono stati rilevati i redditi di 140 persone che vivono al nord e quelli di 170 che vivono al sud: il reddito medio di chi vive al nord è di 32.2 mila euro annui con una SD pari a 2.4 mila euro annui, mentre il
...
6.c **(Punti 2/101 $\rightarrow$ 0.61/31)** Cos'è un _punto influente_?

6.d **(Punti 2/101 $\rightarrow$ 0.61/31)** Se $W=10+ Y$, posto
$$w_i=\beta_0'+\beta_1'x_ì +\epsilon_i'$$
...
1.c **(Punti 2/106 $\rightarrow$ 0.58/31)**  La spesa media è pari a $\bar x=12.0227$ mila euro, 
...
1.d **(Punti 2/106 $\rightarrow$ 0.58/31)** La spesa media in investimenti green su 220 aziende modenesi è pari a $\bar x=12.0227$ mila euro, mentre la spesa media  in investimenti green della provincia di Reggio, su un campione di 150 aziende è pari a $12.22$ mila euro.
...
2.c **(Punti 2/106 $\rightarrow$ 0.58/31)** Siano $A$ e $B$ due eventi diversi dal vuoto. È vero che se $A$ e $B$ sono 
...
2.d **(Punti 2/106 $\rightarrow$ 0.58/31)** Se $F$ è la funzione di ripartizione della VA $X$, 
...
**Teorema del Limite Centrale (somma VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=365$ VC IID, tc $E(X_i)=\mu=26.34$ e $V(X_i)=\sigma^2=1.69,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
4.a **(Punti 3/106 $\rightarrow$ 0.88/31)** Sia $\hat \lambda$ lo stimatore di massima verosimiglianza di $\lambda$ del modello di Poisson: $\hat\lambda =  \frac 1n\sum_{i=1}^nx_i$
Scrivere lo Standard Error di $\hat \lambda$.

4.b **(Punti 3/106 $\rightarrow$ 0.88/31)** Se $h$ è uno stimatore per $\theta$ tale che
...
4.d **(Punti 3/106 $\rightarrow$ 0.88/31)** In un confronto tra due campioni viene messo a test
$$
\begin{cases}
H_0:\sigma_A=\sigma_B\\
H_1:\sigma_A\ne \sigma_B
...
5.b **(Punti 11/106 $\rightarrow$ 3.22/31)** La stessa domanda è stata posta ad un secondo campione di $n_S=38$ consumatori privati,scelti a caso tra i cittadini del comune di Sassuolo. 
...
6.b **(Punti 3/106 $\rightarrow$ 0.88/31)** Scrivere la scomposizione della varianza del modello di regressione 
...
6.e **(Punti 2/106 $\rightarrow$ 0.58/31)** Se $W=5+ Y$, posto $w_i=\beta_0'+\beta_1'x_ì +\epsilon_i'$
il modello in cui $W$ viene spiegata da $X$, quanto varranno $\beta_0'$ e $\beta_1'$?
...
1.d **(Punti 2/103 $\rightarrow$ 0.6/31)** La varianza della spesa è pari a $Var=17.997$.
...
2.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Si osserva la rotatoria per $n=6$ minuti. Qual è
...
2.c **(Punti 2/103 $\rightarrow$ 0.6/31)** Se $X\sim N(0,2)$ e $X\sim N(1,1.2)$, è vero che
$$
X-Y\sim N(-1,0.8) \qquad ?
$$


2.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Se $X$ è una VC con supporto {0,1,2} e $Y$ è una VC con supporto {2,3,4,5}.
...
3.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Un'urna contiene 10 palline numerate da 1 a 10. 
...
**Teorema del Limite Centrale (somma di Bernoulli)** 
 ...
 Siano $X_1$,...,$X_n$, $n=50$ VC IID, tc $X_i\sim\text{Ber}(\pi=0.3)$$,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
4.d **(Punti 3/103 $\rightarrow$ 0.9/31)** Se in un test statistico che utilizza la statistica test _t_ con 10 gradi di libertà $t_\text{obs}=1.4$, il $p_\text{value}$ sarà maggiore o minore di 0.05? Perché?
...
5.a **(Punti 3/103 $\rightarrow$ 0.9/31)** Costruire un intervallo di confidenza la 95% per $\pi$ la quota di persone del quartiere _Q_ favorevole alle corsie preferenziali
...
5.b **(Punti 11/103 $\rightarrow$ 3.31/31)** Un'indagine molto più ampia condotta su tutta la città ha mostrato che
...
6.c **(Punti 2/103 $\rightarrow$ 0.6/31)** Cosa sono i _punti influenti_?

6.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Se $W=2\times Y$ e $V=X+3$, posto $w_i=\beta_0'+\beta_1'v_ì +\epsilon_i'$
...
1.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Qual è la percentuale di aziende che hanno una spesa 
...
1.d **(Punti 2/103 $\rightarrow$ 0.6/31)** La varianza della spesa è pari a $Var=17.075$.
...
2.c **(Punti 2/103 $\rightarrow$ 0.6/31)** Se $X\sim \text{Pois}(2)$ e $Y\sim\text{Pois}(1)$, è vero che
$$
X-Y\sim\text{Pois}(1)\qquad ?
$$


2.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Se $X$ è una VC con supporto {0,1,2} e $X$ è una VC con supporto {-2,-1,0}.
...
3.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Il supermercato _S_ vende, in media ogni giorno, 102.3 kg di pasta, con una deviazione standard di 10.2. Dopo 60 giorni di apertura, qual è la probabilità che il totale di pasta venduta sia maggiore di 6700 kg?


**Teorema del Limite Centrale (somma VC qualunque)** 

 Siano $X_1$,...,$X_n$, $n=60$ VC IID, tc $E(X_i)=\mu=102$ e $V(X_i)=\sigma^2=104,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
4.d **(Punti 3/103 $\rightarrow$ 0.9/31)** Se in un test statistico che utilizza la statistica test _t_ con 10 gradi di libertà $t_\text{obs}=14$, il $p_\text{value}$ sarà maggiore o minore di 0.05? Perché?
...
5.a **(Punti 3/103 $\rightarrow$ 0.9/31)** Costruire un intervallo di confidenza la 99% per $\mu$ il punteggio medio che le persone del quartiere _Q_ esprimono riguardo alle corsie preferenziali.
...
6.c **(Punti 2/103 $\rightarrow$ 0.6/31)** Che differenza c'è tra _interpolazione_ e _estrapolazione_?
...
1.b **(Punti 3/106 $\rightarrow$ 0.88/31)** Quante imprese hanno un bilancio compreso tra $-4$ mila 
euro e zero.
...
1.c **(Punti 2/106 $\rightarrow$ 0.58/31)**  La media è risultata essere $\bar x=8.446$; che
...
1.d **(Punti 2/106 $\rightarrow$ 0.58/31)** Siano $x_1,...,x_n$, $n$ numeri, $n$ dispari. 
...
2.c **(Punti 2/106 $\rightarrow$ 0.58/31)** Siano $A$ e $B$ due eventi diversi dal vuoto.
...
2.d **(Punti 2/106 $\rightarrow$ 0.58/31)** Sia $X\sim\text{Pois}(\lambda=1)$, disegnare la
...
3.a **(Punti 14/106 $\rightarrow$ 4.09/31)** Un'urna contiene tre palline, una Rossa, una Blue e una Nera. Si vince
...
**Teorema del Limite Centrale (proporzione)** 
 ...
 Siano $X_1$,...,$X_n$, $n=144$ VC IID, tc $X_i\sim\text{Ber}(\pi=0.333)$$,\forall i$, posto:
      \[
      \hat\pi=\frac{S_n}n = \frac{X_1 + ... + X_n}n
      \]
      allora:\begin{eqnarray*}
...
4.c **(Punti 3/106 $\rightarrow$ 0.88/31)** Definire gli errori di primo e di secondo 
...
5.a **(Punti 14/106 $\rightarrow$ 4.09/31)** In uno studio sule preferenze di genere è stato chiesto ad un campione di 150 persone,
...
6.e **(Punti 2/106 $\rightarrow$ 0.58/31)** Gli stimatori $\hat\beta_0$ e $\hat\beta_1$ dei minimi 
...
1.b **(Punti 3/106 $\rightarrow$ 0.88/31)** Quante aziende hanno un bilancio compreso tra il 25-esimo 
...
1.d **(Punti 2/106 $\rightarrow$ 0.58/31)** Siano $x_1,...,x_n$, $n$ numeri. Si consideri la funzione:
$$g(x)=(x_1-x)^2+...+(x_n-x)^2.$$
Per quale valore di $x$, $g(x)$ è minima?
...
2.a **(Punti 14/106 $\rightarrow$ 4.09/31)** Si consideri l'evento $E$="più di due veicoli 
...
2.b **(Punti 3/106 $\rightarrow$ 0.88/31)** Calcolare
$$
...
2.c **(Punti 2/106 $\rightarrow$ 0.58/31)** Siano $X\sim N(0,1)$ e $Y\sim N(0,1)$, $X$ e $Y$ indipendenti.
Come si distribuisce $X^2+Y^2$?


2.d **(Punti 2/106 $\rightarrow$ 0.58/31)** Se $X$ è una VC con supporto {2,3,4,5} e $Y$ è una VC con supporto 
{1,2,6}.
Qual è il supporto di $X-Y$?
...
3.a **(Punti 14/106 $\rightarrow$ 4.09/31)** Un'urna contiene 4 palline numerate da 1 a 4. 
...
4.b **(Punti 3/106 $\rightarrow$ 0.88/31)** Sia $\hat\sigma^2$ lo stimatore di massima verosimiglianza
di $\sigma^2$. In virtù di quale proprietà $\hat \sigma$ è lo stimatore di
massima verosimiglianza per $\sigma$?

4.c **(Punti 3/106 $\rightarrow$ 0.88/31)** Siano $T_1$ e $T_2$ due test per lo stesso sistema di ipotesi,
...
4.d **(Punti 3/106 $\rightarrow$ 0.88/31)** Se in un test statistico bilaterale che utilizza 
...
5.b **(Punti 11/106 $\rightarrow$ 3.22/31)** La stessa domanda è stata posta ad un secondo campione di $n_F=38$ consumatori privati,scelti a caso tra i cittadini del comune di Ferrara. 
...
6.b **(Punti 3/106 $\rightarrow$ 0.88/31)** Calcolare numericamente $RSS$:
$$
...
6.c **(Punti 3/106 $\rightarrow$ 0.88/31)** Gli stimatori $\hat\beta_0$ e $\hat\beta_1$ sono consistenti? 
Perché?

6.d **(Punti 2/106 $\rightarrow$ 0.58/31)** Se in un modello di regressione con 11 dati, 
il residuo studentizzato del dato $i$ è $\tilde \epsilon_i=1.23$, cosa possiamo concludere?

6.e **(Punti 2/106 $\rightarrow$ 0.58/31)** Sia $\hat\beta_1$ lo stimatore dei minimi quadrati per $\beta_1$.
...
1.b **(Punti 3/101 $\rightarrow$ 0.92/31)** Quante aziende hanno un bilancio compreso tra $-1$ e il 75-esimo 
percentile?
...
1.d **(Punti 2/101 $\rightarrow$ 0.61/31)** Sapendo che $\sigma_X=2.82$ la Standard Deviation di $X$
...
2.c **(Punti 2/101 $\rightarrow$ 0.61/31)** Se $X$ è una VC con supporto {1,2,3} e $Y$ è una VC con 
supporto {1,3,5}.
Qual è il supporto di $X\times Y$?
...
3.a **(Punti 14/101 $\rightarrow$ 4.3/31)** Il supermercato _S_ accoglie, in media ogni giorno, 3.242 mila persone, con una
...
**Teorema del Limite Centrale (somma VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=60$ VC IID, tc $E(X_i)=\mu=3.24$ e $V(X_i)=\sigma^2=0.25,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
4.b **(Punti 3/101 $\rightarrow$ 0.92/31)** Sia $\hat\theta$ lo stimatore di massima verosimiglianza 
...
4.d **(Punti 3/101 $\rightarrow$ 0.92/31)** Se in un test statistico bilaterale che utilizza la statistica test _z_ , risulta $z_\text{obs}=14$, il $p_\text{value}$ sarà maggiore o minore di 0.01? Perché?
...
5.b **(Punti 11/101 $\rightarrow$ 3.38/31)** La stessa domanda è stata posta ad un secondo 
...
6.c **(Punti 2/101 $\rightarrow$ 0.61/31)** Se in un modello di regressione con 15 dati, 
il residuo studentizzato del dato $i$ è $\tilde \epsilon_i=12.3$, cosa possiamo concludere?


6.d **(Punti 2/101 $\rightarrow$ 0.61/31)** Sia $\hat\beta_0$ lo stimatore dei minimi quadrati per $\beta_0$.
...
1.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Disegnare l'istogramma di densità percentuale. 
...
1.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Che percentuale di famiglie investe più di 4.5 mila euro all'anno?
...
1.c **(Punti 2/103 $\rightarrow$ 0.6/31)** Che relazione dobbiamo aspettarci tra media e mediana? 

1.d **(Punti 2/103 $\rightarrow$ 0.6/31)** La spesa media è pari a $\bar x=3.0676$, mentre la SD è pari a $SD=1.3653$.
...
2.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Siano $X\sim N(10,1.5)$ e sia $Y\sim N(10,0.5)$, $X$ e $Y$ indipendenti. Posto $A=\{8<X<10\}$, $B=\{Y<11\}$. 
...
2.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Un'urna contiene due palline rosse, due bianche e una nera. Si estrae due volte senza reinserimento. Qual è la probabilità di avere due colori diversi?  
...
2.c **(Punti 2/103 $\rightarrow$ 0.6/31)** Se $X\sim\text{Pois}(3.2)$ e $Y\sim\text{Pois}(1.2)$, $X$ e $Y$ indipendenti, quali sono valore atteso e varianza di $X+Y$ e di $X-Y$? 

2.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Sia $X$ una VC e sia $F$ la sua funzione di ripartizione. Cosa significa dire che $F$ è continua a destra?



### Esercizio 3 

3.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Un'urna contiene 4 palline numerate: $\fbox{0}$, $\fbox{0}$, $\fbox{0}$ e $\fbox{1}$. Si estrae 100 volte con reinserimento. Qual è la probabilità che la proporzione di palline timbrate con 1 nelle 100 estrazioni sia maggiore di 0.27?
...
**Teorema del Limite Centrale (proporzione)** 
 ...
 Siano $X_1$,...,$X_n$, $n=100$ VC IID, tc $X_i\sim\text{Ber}(\pi=0.25)$$,\forall i$, posto:
      \[
      \hat\pi=\frac{S_n}n = \frac{X_1 + ... + X_n}n
      \]
      allora:\begin{eqnarray*}
...
4.a **(Punti 3/103 $\rightarrow$ 0.9/31)** Sia $\hat \lambda$ lo stimatore di massima verosimiglianza di $\lambda$ del modello di Poisson.
\begin{eqnarray*}
  \hat\lambda &=&  \frac 1n\sum_{i=1}^nx_i\\
\end{eqnarray*}
Ricavare il suo $MSE$ (Mean Squared Error). 

4.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Si $h$ uno stimatore per $\theta$ tale che $E(h)=\theta$. Di quale proprietà gode $h$? 

4.c **(Punti 3/103 $\rightarrow$ 0.9/31)** Definire la potenza di un test. 

4.d **(Punti 3/103 $\rightarrow$ 0.9/31)** In uno studio sull'efficacia degli integratori alimentari, su un gruppo di 238 atleti è stato misurato il rendimento atletico (ottimo, buono e scarso) e l'assunzione di integratori (alto, medio e basso). Qui di seguito i dati:
...
Siccome $1.9955<|t_\text{obs}|=2.5719<2.6501$, quindi **rifiuto** $H_0$ al 5%, 
...
6.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Stimare la previsione per $x=1.5$ nel modello di regressione dove $Y$ viene spiegata da $X$. 
...
6.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Qual è la percentuale di varianza spiegata dal modello? 
...
6.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Se $W=- Y$, quanto varrà $r_{XW}$, coefficiente di correlazione tra $X$ e $W$?
...
1.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Quante famiglie investono più di 8 mila euro all'anno? 
...
1.d **(Punti 2/103 $\rightarrow$ 0.6/31)** La spesa media è pari a $\bar x=6.9001$, mentre la SD è pari a $SD=1.5027$.
...
2.a **(Punti 14/103 $\rightarrow$ 4.21/31)** I clienti in fila nell'ora di punta alla cassa di un supermercato sono distribuiti come una Poisson di parametro 2.5 ($X\sim\text{Pois}(\lambda=2.5)$). Qual è la probabilità di trovare almeno 2 clienti in coda ($X\ge 2$)? 
...
2.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Un'urna contiene 5 palline: 2 rosse e 3 bianche. Si estrae con reintroduzione finché non escono 2 bianche consecutive. Calcolare la probabilità di finire in __esattamente__ 3 estrazioni. 
...
2.c **(Punti 2/103 $\rightarrow$ 0.6/31)** Se $X\sim N(3.2,1.5)$ e $Y\sim N(1.2,1.1)$, $X$ e $Y$ indipendenti, come si distribuiscono $X+Y$ e  $X-Y$? 

2.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Sia $X$ una VC e sia $F$ la sua funzione di ripartizione. Cosa significa dire che $F$ è crescente?
...
3.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Un'urna contiene 4 palline numerate con $\fbox{0}$, $\fbox{3}$, $\fbox{4}$ e $\fbox{6}$. Si estrae 100 volte con reinserimento. Qual è la probabilità che la somme delle 100 estrazioni sia maggiore di 310?
...
**Teorema del Limite Centrale (somma VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=100$ VC IID, tc $E(X_i)=\mu=3.25$ e $V(X_i)=\sigma^2=4.688,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
5.a **(Punti 14/103 $\rightarrow$ 4.21/31)** In uno studio sul gradimento dell'azione politica della regione, nel comune $A$ si è rilevato che 26 persone su 35 intervistati è soddisfatto, mentre nel comune $B$, 45 su 50 sono soddisfatti.
...
6.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Se $W= 1 - Y$, quanto varrà $r_{XW}$, coefficiente di correlazione tra $X$ e $W$?
...
1.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Quante famiglie investono meno di 4.5 mila euro all'anno? 
...
1.d **(Punti 2/103 $\rightarrow$ 0.6/31)** La spesa media è pari a $\bar x=4.9926$, mentre la SD è pari a $SD=1.5124$.
...
2.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Un'urna contiene 20 palline: 8 bianche e 12 nere, si estrae con reintroduzione 5 volte. 
...
2.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Dalla stessa urna di prima, si estrae con reintroduzione finché non escono due palline bianche consecutive. Qual è la probabilità di finire in __al massimo__ 3 tentativi? 
...
2.c **(Punti 2/103 $\rightarrow$ 0.6/31)** Se $X\sim N(3.2,1.1)$ e $Y\sim\text{Binom}(12,0.3)$, $X$ e $Y$ indipendenti, quali sono valore atteso e varianza di $X+Y$ e di $X-Y$? 

2.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Sia $X$ una VC e sia $F$ la sua funzione di ripartizione. Quanto valgono $\lim_{x\to-\infty}F(x)$ e $\lim_{x\to+\infty}F(x)$?
...
3.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Un'urna contiene 4 palline numerate: $\fbox{0}$, $\fbox{1}$, $\fbox{4}$ e $\fbox{6}$. Si estrae 100 volte con reinserimento. Qual è la probabilità che la media delle 100 estrazioni sia maggiore di 2.8?
...
**Teorema del Limite Centrale (media VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=100$ VC IID, tc $E(X_i)=\mu=2.75$ e $V(X_i)=\sigma^2=5.688,\forall i$, posto:
      \[
      \bar X=\frac{S_n}n =\frac{X_1 + ... + X_n}n
      \]
      allora:\begin{eqnarray*}
...
4.a **(Punti 3/103 $\rightarrow$ 0.9/31)** Siano $\hat \mu$ e $\hat\sigma^2$ gli stimatori di massima verosimiglianza di $\mu$ e $\sigma^2$ del modello di Normale.
\begin{eqnarray*}
...
4.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Si $h$ uno stimatore per $\theta$ tale che $E(h)\ne\theta$, ma che $\lim_{n\to\infty}E(h)=\theta$. Di quale proprietà gode $h$? 

4.c **(Punti 3/103 $\rightarrow$ 0.9/31)** Quali sono gli errori di primo e secondo tipo? 
...
5.b **(Punti 11/103 $\rightarrow$ 3.31/31)** Un'indagine analoga, svolta sull'intera regione, ha mostrato un gradimento medio pari a $\mu_0=71$. Testare l'ipotesi che nel comune A il livello di gradimento sia uguale a quello regionale contro l'alternativa che sia __minore__.
...
Siccome $t_\text{obs}=-3.4986<-1.307$, quindi **rifiuto** $H_0$ sotto all'1‰,
...
6.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Calcolare e interpretare $R^2$. 
...
1.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Individuare la classe modale.
...
1.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Quale è il numero di imprese che hanno un utile maggiore di zero?
...
1.c **(Punti 2/103 $\rightarrow$ 0.6/31)** L'utile medio è pari a $\bar x=1.7013$ che forma avrà l'istogramma?

1.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Qual è la proprietà di associatività della media aritmetica?
...
2.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Siano $X\sim N(1,1.5)$ e sia $Y\sim N(1,0.5)$, $X$ e $Y$ indipendenti. Posto $A=\{-2<X<1\}$, $B=\{Y<1\}$. 
...
2.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Un'urna contiene 10 palline rosse, 10 bianche e 10 nere. Si estrae tre volte senza reinserimento. Qual è la probabilità di avere tre colori uguali? 
...
2.c **(Punti 2/103 $\rightarrow$ 0.6/31)** Se $X\sim\text{Ber}(0.2)$ e $Y\sim\text{Ber}(0.2)$, $X$ e $Y$ indipendenti, com'è distribuita $X+Y$?

2.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Se $X$ è $Y$ sono due VC, tali che $V(X)=\sigma_X^2$ e $Y=\sigma_Y^2$, quanto vale $V(X-Y)$?



### Esercizio 3

3.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Un'urna contiene 4 palline numerate: $\fbox{0}$, $\fbox{1}$, $\fbox{2}$ e $\fbox{3}$. Si estrae 100 volte con reinserimento. Qual è la probabilità che la media delle 100 estrazioni sia maggiore di 1.6?
...
**Teorema del Limite Centrale (media VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=100$ VC IID, tc $E(X_i)=\mu=1.5$ e $V(X_i)=\sigma^2=1.25,\forall i$, posto:
      \[
      \bar X=\frac{S_n}n =\frac{X_1 + ... + X_n}n
      \]
      allora:\begin{eqnarray*}
...
4.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Sia $h$ uno stimatore per $\theta$. Cosa significa dire che $h$ è consistente?

4.c **(Punti 3/103 $\rightarrow$ 0.9/31)** Siano $T_1$ e $T_2$ due test per lo stesso sistema d'ipotesi e con probabilità di errore di secondo tipo pari a, $\beta_1=0.2$ e $\beta_2=0.3$, rispettivamente. A parità di significatività, quale dei due è più potente? Perché?
...
5.a **(Punti 14/103 $\rightarrow$ 4.21/31)** In uno studio sull'efficacia degli integratori alimentari, su un gruppo di 238 atleti è stato misurato il rendimento atletico (ottimo, buono e scarso) e l'assunzione di integratori (alto, medio e basso). Qui di seguito i dati:
...
6.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Stimare la previsione per $x=3.5$ nel modello di regressione dove $Y$ viene spiegata da $X$.
...
1.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Individuare il valore approssimato della mediana.
...
1.c **(Punti 2/103 $\rightarrow$ 0.6/31)** L'utile medio è pari a $\bar x=-1.662$ che forma avrà l'istogramma?

1.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Qual è la proprietà di linearità della media aritmetica?
...
2.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Il numero di telefonate in arrivo nell'ora di punta di un centralino è distribuito come una Poisson di parametro 3.1 ($X\sim\text{Pois}(\lambda=3.1)$). Qual è la probabilità di trovare al massimo 3 telefonate ($X\le 3$)?
...
2.c **(Punti 2/103 $\rightarrow$ 0.6/31)** Se $X\sim N(\mu_X,\sigma_X^2)$ e $Y\sim N(\mu_Y,\sigma_Y^2)$, $X$ e $Y$ indipendenti, come si distribuiscono $X+Y$ e  $X-Y$?

2.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Siano $A$ e $B$ due eventi diversi dal vuoto tali che $A\cap B=\emptyset$, motivare perché $A$ e $B$ non possono essere indipendenti.



### Esercizio 3

3.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Un'urna contiene 2 palline numerate con $\fbox{0}$, 3 numerate con $\fbox{1}$ e 2 numerate con $\fbox{2}$. Si estrae 100 volte con reinserimento. Qual è la probabilità che la somma delle 100 estrazioni sia compresa tra 80 e 120?
...
**Teorema del Limite Centrale (somma VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=100$ VC IID, tc $E(X_i)=\mu=1$ e $V(X_i)=\sigma^2=0.571,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
5.a **(Punti 14/103 $\rightarrow$ 4.21/31)** In uno studio comparativo tra i redditi, nel comune $A$ si è rilevato il reddito di 12 individui e si è osservata una media pari 27 mila euro con una standard deviation pari a 4.2 mila euro , mentre nel comune $B$ si è rilevato il reddito di 25 individui e si è osservata una media pari 24 mila euro con una standard deviation pari a 3.1 mila euro.
...
Siccome $1.6896<t_\text{obs}=2.1192<2.4377$, quindi **rifiuto** $H_0$ al 5%, 
...
6.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Se $V= 1 - Y$ e $W= 1 - X$ quanto varrà $r_{VW}$, coefficiente di correlazione tra $V$ e $W$?
...
1.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Quante imprese hanno un utile negativo?
...
1.d **(Punti 2/103 $\rightarrow$ 0.6/31)** La varianza dei dati è pari a $\hat\sigma^2=15.1386$, se gli utili di ogni impresa aumentassero del 3%, quanto varrebbe la varianza dei dati così trasformati?
...
2.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Si lancia una moneta perfetta 8 volte. Qual è la probabilità di avere un numero di volte Testa maggiore o uguale a 6 su 8 lanci?
...
2.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Sia $Z\sim N(0,1)$ e siano $A=\{Z<0\}$ e $B=\{Z<1\}$. Calcolare $P(A|B)$
...
2.c **(Punti 2/103 $\rightarrow$ 0.6/31)** Se $X\sim\text{Pois} (n)$, a cosa tende $X$ se $n$ diverge?
...
2.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Sia $X\sim N(10,1)$  e sia $F$ la sua funzione di ripartizione. Disegnare approssimativamente $F(x)$ per $x$ che varia tra 6 e 14.
...
3.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Un'urna conteni tre palline rosse, due bianche e una nera. Si estrae $n=100$ volte con reintroduzione. Qual è la probabilità che la proporzione di palline rosse sia minore di 0.45?

:::{.sol data-latex=""}
**Teorema del Limite Centrale (proporzione)** 

 Siano $X_1$,...,$X_n$, $n=100$ VC IID, tc $X_i\sim\text{Ber}(\pi=0.5)$$,\forall i$, posto:
      \[
      \hat\pi=\frac{S_n}n = \frac{X_1 + ... + X_n}n
      \]
      allora:\begin{eqnarray*}
...
4.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Se $h_1$ e $h_2$ sono due stimatori per $\theta$ cosa significa dire che $h_1$ è più efficiente di $h_2$?

4.c **(Punti 3/103 $\rightarrow$ 0.9/31)** Definire gli errori di primo e secondo tipo e le relativa probabilità.

4.d **(Punti 3/103 $\rightarrow$ 0.9/31)**  Una moneta, che non sappiamo se è perfetta oppure no, viene lanciata 40 volte. Abbiamo osservato 14 volte testa su 40 lanci. Posto $\pi$ la probabilità che la moneta mostri testa, si è testato
\[
\begin{cases}
H_0:\pi=\frac 12\\
H_1:\pi\ne\frac 12
...
5.a **(Punti 3/103 $\rightarrow$ 0.9/31)** In uno studio sui redditi, nel comune $A$ si è rilevato il reddito di $n=35$ individui e si è osservata una media pari $68$ mila euro con una standard deviation pari a $5$ mila euro.
...
5.b **(Punti 11/103 $\rightarrow$ 3.31/31)** Un'indagine analoga, svolta sull'intera regione, ha mostrato un reddito medio pari a $\mu_0=71$. Testare l'ipotesi che nel comune $A$ il reddito medio sia uguale a quello regionale contro l'alternativa che sia __diverso__.
...
Siccome $2.7284<|t_\text{obs}|=3.4986<3.6007$, quindi **rifiuto** $H_0$ all'1%, 
...
6.c **(Punti 2/103 $\rightarrow$ 0.6/31)** Interpretare il qq-plot dei residui.

\begin{center}\includegraphics{Esami_passati_con_soluzioni_files/figure-latex/2023-32,-1} \end{center}

6.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Se $V=1+ Y$ e $W=1-X$, quanto varrà $r_{VW}$, il coefficiente di correlazione tra $V$ e $W$?
...
1.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Qual è la percentuale di famiglie con spesa superiore a 4 mila euro?
...
1.c **(Punti 2/103 $\rightarrow$ 0.6/31)** Che relazione dobbiamo attenderci tra moda, mediana e media?

1.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Cosa significa che la media aritmetica rende zero la somma degli scarti?
...
2.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Calcolare la probabilità di  $A\cup B$.
...
2.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Calcolare la probabilità che **solo** uno dei due eventi $A$ oppure $B$ sia vero.

2.c **(Punti 2/103 $\rightarrow$ 0.6/31)** Calcolare valore atteso e varianza di $X_A-X_B$.

2.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Sia $X\sim\text{Ber}(\pi=0.4)$. Disegnare la sua funzione di ripartizione.



### Esercizio 3

3.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Un'urna contiene 3 palline Rosse, 3 Bianche e 4 Blu. Si estrae con reintroduzione per $n=81$ volte.
Calcolare la probabilità che la proporzione di palline Blu sia maggiore di 0.3.

:::{.sol data-latex=""}
**Teorema del Limite Centrale (proporzione)** 

 Siano $X_1$,...,$X_n$, $n=81$ VC IID, tc $X_i\sim\text{Ber}(\pi=0.4)$$,\forall i$, posto:
      \[
      \hat\pi=\frac{S_n}n = \frac{X_1 + ... + X_n}n
      \]
      allora:\begin{eqnarray*}
...
4.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Se $h_1$ e $h_2$ sono due stimatori per $\theta$ tale per cui $MSE(h_1)=1.2$, e $MSE(h_2)=2.3$, quale dei due è più efficiente e perché?

4.c **(Punti 3/103 $\rightarrow$ 0.9/31)** Definire gli errori di primo e secondo tipo e le relative probabilità.

4.d **(Punti 3/103 $\rightarrow$ 0.9/31)**  Una moneta, che non sappiamo se è perfetta oppure no, viene lanciata 80 volte. Abbiamo osservato 28 volte testa su 80 lanci. Posto $\pi$ la probabilità che la moneta mostri testa, si è testato
\[
\begin{cases}
H_0:\pi=\frac 12\\
H_1:\pi\ne\frac 12
...
5.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Stimare il modello di regressione dove $Y$ viene spiegata da $X$.
...
5.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Qual è la percentuale di varianza spiegata dal modello?
...
5.c **(Punti 14/103 $\rightarrow$ 4.21/31)** Testare l'ipotesi che l'intercetta sia uguale a zero contro l'alternativa che sia diversa da zero.
...
Essendo $|t_\text{obs}|=1.2739<t_{50-2;0.025}=2.0106$ allora **non** rifiuto $H_0$ al 5%.
...
5.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Interpretare il diagramma dei residui.
...
5.e **(Punti 2/103 $\rightarrow$ 0.6/31)** Perché una previsione per $x=15$ è più affidabile di una per $x=50$?
...
1.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Qual è la percentuale di famiglie con spesa compresa tra a 4 mila e 8 mila euro?
...
1.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Cosa significa che la media aritmetica gode della proprietà di linearità?
...
2.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Si continua ad estrarre da $X_A\sim N(1.5,1.5)$ e si interrompe quando $X_A\le 1$. Calcolare la probabilità di interrompere alla quinta estrazione.
...
2.c **(Punti 2/103 $\rightarrow$ 0.6/31)** Come si distribuisce $X_A-X_B$?

2.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Se $A$ e $B$ sono due eventi tali che $A\cap B=\emptyset$, $A$ e $B$ possono essere indipendenti? Perché?
...
3.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Un'urna contiene 3 palline col numero $\fbox{0}$, 3 col numero $\fbox{1}$ e 4 col numero $\fbox{2}$. Si estrae con reintroduzione per $n=81$ volte.
Calcolare la probabilità che la somma dei risultati sia maggiore di 80.

:::{.sol data-latex=""}
\begin{eqnarray*}
 \mu &=&  0  \cdot 0.3+ 1  \cdot 0.3+ 2  \cdot 0.4 = 1.1 \\ \sigma^2 &=&(  0 ^2 \cdot 0.3+ 1 ^2 \cdot 0.3+ 2 ^2 \cdot 0.4 )-( 1.1 )^2= 0.69 \end{eqnarray*}**Teorema del Limite Centrale (somma VC qualunque)** 

 Siano $X_1$,...,$X_n$, $n=81$ VC IID, tc $E(X_i)=\mu=1.1$ e $V(X_i)=\sigma^2=0.69,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
4.a **(Punti 3/103 $\rightarrow$ 0.9/31)** Sono stati estratti $n=10$ valori da una Poisson di parametro $\lambda$ incognito e si è ottenuta un media pari a $\bar x=3.4$. Ricavare $\widehat{SE(\hat\lambda)}$ lo Standard Error stimato $\hat\lambda$ di massima verosimiglianza.

4.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Sia $h$ uno stimatore per $\theta$. Cosa significa dire che $h$ è consistente?

4.c **(Punti 3/103 $\rightarrow$ 0.9/31)** Siano $T_1$ e $T_2$ due test per lo stesso sistema d'ipotesi e con probabilità di errore di secondo tipo pari a, $\beta_1=0.02$ e $\beta_2=0.3$, rispettivamente. A parità di significatività, quale dei due è più potente? Perché?
...
6.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Stimare il modello di regressione dove $Y$ viene spiegata da $X$.
...
6.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Posto $W=-2\cdot Y$ calcolare $\beta_0'$ e $\beta_1'$ i coefficienti di regressione del modello
\[
...
1.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Qual è il numero di famiglie con spesa compresa tra a 4 mila e 8 mila euro?
...
1.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Cosa significa che la media aritmetica goe della proprietà di linearità?
...
2.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Si estrae ripetutamente da $X\sim\text{Binom}(5,0.5)$ e ci si ferma quando $X\le 1$. Calcolare la probabilità di finire entro due estrazioni.
...
2.c **(Punti 2/103 $\rightarrow$ 0.6/31)** Calcolare valore atteso e varianza di $X-Y$.

2.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Siano $A$ e $B$ due eventi tali che $P(A)=0.6$ e $P(B)=0.5$. $A$ e $B$ possono essere incompatibili? Perché?



### Esercizio 3

3.a **(Punti 14/103 $\rightarrow$ 4.21/31)** Un'urna contiene 3 palline col numero $\fbox{0}$, 4 col numero $\fbox{1}$ e 3 col numero $\fbox{2}$. Si estrae con reintroduzione per $n=81$ volte.
Calcolare la probabilità che la media dei risultati sia minore di 0.9.

:::{.sol data-latex=""}
\begin{eqnarray*}
 \mu &=&  0  \cdot 0.3+ 1  \cdot 0.4+ 2  \cdot 0.3 = 1 \\ \sigma^2 &=&(  0 ^2 \cdot 0.3+ 1 ^2 \cdot 0.4+ 2 ^2 \cdot 0.3 )-( 1 )^2= 0.6 \end{eqnarray*}**Teorema del Limite Centrale (media VC qualunque)** 

 Siano $X_1$,...,$X_n$, $n=81$ VC IID, tc $E(X_i)=\mu=1$ e $V(X_i)=\sigma^2=0.6,\forall i$, posto:
      \[
      \bar X=\frac{S_n}n =\frac{X_1 + ... + X_n}n
      \]
      allora:\begin{eqnarray*}
...
4.a **(Punti 3/103 $\rightarrow$ 0.9/31)** Sono stati estratti $n=10$ valori da una Bernoulli di parametro $\pi$ incognito e si è ottenuti 4 successi in 10 estrazioni. Ricavare, $\widehat{SE(\hat\pi)}$ lo Standard Error stimato di $\hat\pi$ di massima verosimiglianza.

4.b **(Punti 3/103 $\rightarrow$ 0.9/31)** Sia $h$ uno stimatore per $\theta$. Cosa significa dire che $h$ è corretto asintoticamente?

4.c **(Punti 3/103 $\rightarrow$ 0.9/31)** Definire gli errori di primo e di secondo tipo e le relative probabilità.

4.d **(Punti 3/103 $\rightarrow$ 0.9/31)** Un dado viene lanciato 60 volte e si ottiene 
\begin{table}[H]
\centering
\begin{tabular}{rrrrrr}
\toprule
...
5.a **(Punti 3/103 $\rightarrow$ 0.9/31)** In uno studio sui consumi per generi di igiene personale su un campione di 35 famiglie della provincia di Reggio è stata chiesta la loro spesa annuale in questo genere di beni. I dati campionari hanno evidenziato una media pari a $\hat\mu=0.5$ e una deviazione standard osservata pari a $\hat\sigma=0.25$.
Costruire un intervallo di confidenza al 95% per il gradimento medio $\mu$.
...
5.b **(Punti 11/103 $\rightarrow$ 3.31/31)** Un'indagine analoga, svolta sull'intera regione, ha mostrato un gradimento medio pari a $\mu_0=0.6$. Testare l'ipotesi che nel comune A il livello di gradimento sia uguale a quello regionale contro l'alternativa che sia minore.
...
Siccome $-2.4411<t_\text{obs}=-2.3324<-1.6909$, quindi **rifiuto** $H_0$ al 5%, 
...
6.d **(Punti 2/103 $\rightarrow$ 0.6/31)** Posto $W=-2\cdot X$ calcolare $\beta_0'$ e $\beta_1'$ i coefficienti di regressione del modello
\[
...
1.b **(Punti 3/105 $\rightarrow$ 0.89/31)** Qual è la percentuale di famiglie con spesa superiore a 60 euro?
...
1.c **(Punti 2/105 $\rightarrow$ 0.59/31)** Che relazione dobbiamo attenderci tra moda, mediana e media?

1.d **(Punti 2/105 $\rightarrow$ 0.59/31)** La spesa media è pari a $\bar x=70.6296$ e la standard deviation $\hat\sigma=56.9043$, se tutte le famiglie risparmiassero
...
2.a **(Punti 14/105 $\rightarrow$ 4.13/31)** Calcolare la probabilità che il totale di telefonate in arrivo in un'ora sia maggiore 
...
2.b **(Punti 3/105 $\rightarrow$ 0.89/31)** Sapendo che $S=X+Y\ge 3$, calcolare la probabilità che $S=X+Y= 5$ ($P(S=5|S\ge 3$)
...
2.c **(Punti 2/105 $\rightarrow$ 0.59/31)** Se $X$ ed $Y$ sono due variabili casuali, è sempre vero che
\[
V(X-Y)=V(X)+V(Y)~~~?
\]
motivare la risposta.

2.d **(Punti 2/105 $\rightarrow$ 0.59/31)** Sia $X\sim\text{Binom}(2,\pi=0.5)$. Disegnare la sua funzione di ripartizione.
...
3.a **(Punti 14/105 $\rightarrow$ 4.13/31)** Una catena di montaggio a ciclo continuo produce ogni giorno un numero di pezzi variabile, con una media pari a
...
**Teorema del Limite Centrale (somma VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=365$ VC IID, tc $E(X_i)=\mu=1.2$ e $V(X_i)=\sigma^2=9.1,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
4.a **(Punti 3/105 $\rightarrow$ 0.89/31)** Siano $\hat \mu$ e $\hat\sigma^2$ gli stimatori di massima verosimiglianza di $\mu$ e $\sigma^2$ del modello di Normale.
\begin{eqnarray*}
  \hat\mu &=&  \frac 1n\sum_{i=1}^nx_i \qquad \hat\sigma^2 =  \frac 1n\sum_{i=1}^n(x_i-\hat\mu)^2\\
\end{eqnarray*}
Come si distribuisce $\hat\mu$?

4.b **(Punti 3/105 $\rightarrow$ 0.89/31)** Sia $h$ uno stimatore per $\theta$ tale che 
\[V(h)=\frac\theta {\sqrt{n}};~~~~E(h)=\theta\frac{n+2}{n}\]
di quali proprietà gode $h$?

4.c **(Punti 3/105 $\rightarrow$ 0.89/31)** Definire il p-value e descrivere la sua interpretazione.

4.d **(Punti 3/105 $\rightarrow$ 0.89/31)**  Se un test è significativo al 5% può essere significativo all'1%? (scegliere la risposta tra: _mai_, _non sempre_ oppure _sempre_ e motivare la risposta)
...
5.a **(Punti 3/105 $\rightarrow$ 0.89/31)** Costruire un intervallo di confidenza al 99%
...
5.b **(Punti 11/105 $\rightarrow$ 3.25/31)** Nel comune $B$ si è condotta un'intervista analoga. 
...
6.a **(Punti 14/105 $\rightarrow$ 4.13/31)** Stimare il modello di regressione dove $Y$ viene spiegata da $X$ e interpretare 
...
6.b **(Punti 3/105 $\rightarrow$ 0.89/31)** Scrivere la scomposizione della varianza e 
...
6.c **(Punti 2/105 $\rightarrow$ 0.59/31)** Perché una previsione per $x=0.15$ è più affidabile di una per $x=50$?

6.d **(Punti 2/105 $\rightarrow$ 0.59/31)** Interpretare il diagramma dei residui.
...
6.e **(Punti 2/105 $\rightarrow$ 0.59/31)** Cosa significa dire che $r$ è un numero puro?
...
1.b **(Punti 3/105 $\rightarrow$ 0.89/31)** Qual è il numero di imprese con spesa superiore ai 100 euro?
...
1.d **(Punti 2/105 $\rightarrow$ 0.59/31)** La spesa media è pari a $\bar x=180.6032$ e varianza $\hat\sigma^2=3061.3555$, se tutte le famiglie aumentassero 
...
2.a **(Punti 14/105 $\rightarrow$ 4.13/31)** Calcolare la probabilità di $A\cup B$.
...
2.b **(Punti 3/105 $\rightarrow$ 0.89/31)** Si lancia una moneta, se esce testa si estrae da una normale $X\sim N(0,1)$, se esce croce si estrae
...
2.c **(Punti 2/105 $\rightarrow$ 0.59/31)** Se $X\sim\text{Pois}(\lambda_X)$ e $Y\sim\text{Pois}(\lambda_Y)$, quali sono valore atteso e varianza 
di $X-Y$?

2.d **(Punti 2/105 $\rightarrow$ 0.59/31)** Se $A$ e $B$ sono due eventi *non* indipendenti come si può scrivere $P(A\cap B)$?
...
**Teorema del Limite Centrale (media VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=365$ VC IID, tc $E(X_i)=\mu=1.3$ e $V(X_i)=\sigma^2=8.1,\forall i$, posto:
      \[
      \bar X=\frac{S_n}n =\frac{X_1 + ... + X_n}n
      \]
      allora:\begin{eqnarray*}
...
4.a **(Punti 3/105 $\rightarrow$ 0.89/31)**Sia $\hat \lambda$ lo stimatore di massima verosimiglianza di $\lambda$ del modello di Poisson: 
\[\hat\lambda =  \frac 1n\sum_{i=1}^nx_i\]
...
4.c **(Punti 3/105 $\rightarrow$ 0.89/31)** Definire la significatività di un test statistico.

4.d **(Punti 3/105 $\rightarrow$ 0.89/31)** Se un test è significativo all'1% può essere significativo all'5%? (scegliere la risposta tra: _mai_, _non sempre_ oppure _sempre_ e motivare la risposta)
...
5.a **(Punti 3/105 $\rightarrow$ 0.89/31)** Costruire un intervallo di confidenza al 95%
per la proporzione dei favorevoli in popolazione.
...
6.b **(Punti 3/105 $\rightarrow$ 0.89/31)** Il modello si adatta bene ai dati?
...
6.c **(Punti 2/105 $\rightarrow$ 0.59/31)** Perché una previsione per $x=0.8$ è più affidabile di una per $x=0$?
...
6.e **(Punti 2/105 $\rightarrow$ 0.59/31)** Cosa significa dire che $r$ è invariante ai cambiamenti di scala?
...
1.a **(Punti 14/105 $\rightarrow$ 4.13/31)** Calcolare il valore approssimato della mediana
...
1.b **(Punti 3/105 $\rightarrow$ 0.89/31)** Qual è il numero di imprese con spesa superiore ai 60 euro?
...
1.d **(Punti 2/105 $\rightarrow$ 0.59/31)** Scrivere la proprietà di associatività della media aritmetica.
...
2.b **(Punti 3/105 $\rightarrow$ 0.89/31)** Sia $X\sim N(2,1)$ e sia $A=\{X>2.5\}$.
...
3.a **(Punti 14/105 $\rightarrow$ 4.13/31)** Una catena di montaggio a ciclo continuo produce un pezzo al giorno e la proporzione di pezzi fallati è pari
a $\pi=0.15$.
...
**Teorema del Limite Centrale (somma di Bernoulli)** 
 ...
 Siano $X_1$,...,$X_n$, $n=365$ VC IID, tc $X_i\sim\text{Ber}(\pi=0.15)$$,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
4.b **(Punti 3/105 $\rightarrow$ 0.89/31)** 4.c **(Punti 3/105 $\rightarrow$ 0.89/31)** Sia $h$ uno stimatore per $\theta$ tale che 
\[V(h)=2\frac\theta {\sqrt{n}};~~~~E(h)=\theta\frac{n+2}{n-1}\]
scrive il Mean Squared Error di $h$ ($MSE(h)$).

4.d **(Punti 3/105 $\rightarrow$ 0.89/31)** Definire la potenza di un test statistico.

4.e **(Punti NA/105 $\rightarrow$ NA/31)** Se un t-test bilaterale con 13 gradi libertà presenta una
...
5.b **(Punti 11/105 $\rightarrow$ 3.25/31)** Nella regione è stata condotta un'indagine analoga
...
Siccome $1.7109<t_\text{obs}=1.7958<2.4922$, quindi **rifiuto** $H_0$ al 5%, 
...
6.c **(Punti 2/105 $\rightarrow$ 0.59/31)** Che differenza c'è tra interpolazione ed estrapolazione?

6.d **(Punti 2/105 $\rightarrow$ 0.59/31)** Definire il diagramma dei residui.

6.e **(Punti 2/105 $\rightarrow$ 0.59/31)** Cosa significa che $\hat\beta_0$ e $\hat\beta_1$ sono BLUE?
...
1.a **(Punti 14/105 $\rightarrow$ 4.13/31)** Individuare la classe modale
...
1.b **(Punti 3/105 $\rightarrow$ 0.89/31)** Qual è la percentuale di imprese con bilancio inferiore a 3 (centomila) euro?
...
1.c **(Punti 2/105 $\rightarrow$ 0.59/31)** la media aritmetica è pari a -2.6643, in base al punto 1a che relazione dobbiamo attenderci tra media, mediana e moda?

1.d **(Punti 2/105 $\rightarrow$ 0.59/31)** Si considerino i seguenti dati
...
2.a **(Punti 14/105 $\rightarrow$ 4.13/31)** Calcolare la probabilità che in almeno uno dei due semafori ci siano 2 o più automobili in coda (suggerimento: _almeno uno_ si rappresenta con l'unione).
...
2.b **(Punti 3/105 $\rightarrow$ 0.89/31)** Per andare al lavoro Michele prende la strada che 
...
2.c **(Punti 2/105 $\rightarrow$ 0.59/31)** Sia $Z\sim N(0,1)$ e $Y\sim \chi^2_2$, $Z$ e $Y$ indipendenti.
Come si distribuisce
\[
\frac{Z}{\sqrt{Y/2}} ~~~?
\]

2.d **(Punti 2/105 $\rightarrow$ 0.59/31)** Se $P(A)=0.3$, $P(B|A)=0.6$, e $P(B|\bar A)=0.4$, quanto valgono $P(B)$ e $P(A|B)$?
...
3.a **(Punti 14/105 $\rightarrow$ 4.13/31)** Un'urna contiene le seguenti palline numerate {3,5,7,11}. Si estrae con reintroduzione per $n=81$ volte.
...
**Teorema del Limite Centrale (media VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=81$ VC IID, tc $E(X_i)=\mu=6.5$ e $V(X_i)=\sigma^2=8.75,\forall i$, posto:
      \[
      \bar X=\frac{S_n}n =\frac{X_1 + ... + X_n}n
      \]
      allora:\begin{eqnarray*}
...
4.b **(Punti 3/105 $\rightarrow$ 0.89/31)** Cosa significa che gli stimatori di massima verosimiglianza sono invarianti alle trasformazioni monotone invertibili?
...
5.b **(Punti 11/105 $\rightarrow$ 3.25/31)**  L'azienda afferma che la media delle spese mensili dei dipendenti è pari a $1100€$. Effettuare un test di ipotesi per verificare se la media delle spese mensili sia superiore a $1100€$.
...
Siccome $t_\text{obs}=1<t_{10-1;0.1}=1.383$, quindi **non** rifiuto $H_0$ a **nessun** livello di significatività, 
...
6.a **(Punti 14/105 $\rightarrow$ 4.13/31)** Stimare il modello di regressione dove $Y$ viene spiegata da $X$ e prevedere il reddito per un individuo con 12 anni di studio.
...
6.b **(Punti 3/105 $\rightarrow$ 0.89/31)** Qual è la percentuale di varianza spiegata dal modello?
...
6.c **(Punti 2/105 $\rightarrow$ 0.59/31)** Stimare lo Standard Error di $\hat\beta_1$.
...
6.d **(Punti 2/105 $\rightarrow$ 0.59/31)** Definire i punti di leva.

6.e **(Punti 2/105 $\rightarrow$ 0.59/31)** Se in un modello di regressione sappiamo che $\hat\sigma_X=0.5$, $\hat\sigma_Y=1.2$ e $r=0.8$, quanto varrà $\hat\beta_1$, il coefficiente angolare del modello di regressione dove $Y$ viene spiegata da $X$?
...
1.b **(Punti 3/105 $\rightarrow$ 0.89/31)** Qual è il numero di famiglie che consuma più di 30 ore di streaming?
...
1.c **(Punti 2/105 $\rightarrow$ 0.59/31)** la media aritmetica è pari a 14.7934, in base al punto 1a che relazione dobbiamo attenderci tra media, mediana e moda?
...
2.a **(Punti 14/105 $\rightarrow$ 4.13/31)**  Calcola la probabilità che almeno uno dei due eventi sia vero ($A \cup B$).
...
2.b **(Punti 3/105 $\rightarrow$ 0.89/31)** Quando il tempo di manutenzione del macchinario $X$ è inferiore a 14 ore ($A=\{X< 14\}$), la perdita economica dell'azienda è di €100. Mentre quando è superiore a 14 la perdita è di 500€.
...
2.c **(Punti 2/105 $\rightarrow$ 0.59/31)**  Siano $Z_1\sim N(0,1)$, $Z_2\sim N(0,1)$, $Z_3\sim N(0,1)$, tre VC normali standard indipendenti.
Come si distribuisce
\[
Y=Z_1^2+Z_2^2+Z_3^3~~~?
\]

2.d **(Punti 2/105 $\rightarrow$ 0.59/31)** Se $A$ e $B$ sono due eventi tali che $A\cap B\ne\emptyset$, $A$ e $B$ sono indipendenti? (scegliere tra _sempre, mai, dipende_ e motivare la risposta)
...
3.a **(Punti 14/105 $\rightarrow$ 4.13/31)** Un'urna contiene le seguenti palline numerate {3,4,5,6,7,11}. Si vine se esce un numero pari. Si estrae con reintroduzione per $n=81$ volte.
...
**Teorema del Limite Centrale (somma di Bernoulli)** 
 ...
 Siano $X_1$,...,$X_n$, $n=81$ VC IID, tc $X_i\sim\text{Ber}(\pi=0.3333)$$,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
4.a **(Punti 3/105 $\rightarrow$ 0.89/31)** Sia $\hat \beta_1$ lo stimatore dei minimi quadrati di $\beta_1$ del modello di regressione lineare.
\begin{eqnarray*}
  \hat\beta_1 &=&  \frac{\text{cov}(X,Y)}{\hat\sigma_X^2}\\
\end{eqnarray*}
Dimostrare la consistenza di $\hat\beta_1$.

4.b **(Punti 3/105 $\rightarrow$ 0.89/31)** Come si distribuiscono gli stimatori di massima verosimiglianze asintoticamente?
...
6.a **(Punti 14/105 $\rightarrow$ 4.13/31)** Si è osservato $x_3=10$ e $y_3=31.84$, stimare il modello di regressione dove $Y$ viene spiegata da $X$ e calcolare il residuo per il punto $i=3$.
...
6.c **(Punti 2/105 $\rightarrow$ 0.59/31)** Stimare lo Standard Error di $\hat\beta_0$.
...
6.d **(Punti 2/105 $\rightarrow$ 0.59/31)** Definire il qq-plot.

6.e **(Punti 2/105 $\rightarrow$ 0.59/31)** Se in un modello di regressione $r=0.35$, $\hat\sigma_X=1.2$ e $\hat\sigma_X=0.5$, quanto varrà
...
1.a **(Punti 14/91 $\rightarrow$ 4.77/31)** Ricavare il valore approssimato della mediana.
...
1.b **(Punti 3/91 $\rightarrow$ 1.02/31)** Qual è il numero di individui che spende più di 150€ al mese?
...
1.c **(Punti 2/91 $\rightarrow$ 0.68/31)** Individuare la classe modale, metterla in relazione con la mediana e indicare la loro relazione con la media.

1.d **(Punti 2/91 $\rightarrow$ 0.68/31)** Michele ha sostenuto tre esami e ha la media del 26, al quarto esame ha preso 28. Qual è la media calcolata sui 4 esami?
...
2.a **(Punti 3/91 $\rightarrow$ 1.02/31)** Qual è la probabilità di avere **esattamente** uno solo due eventi sia vera?
...
2.b **(Punti 2/91 $\rightarrow$ 0.68/31)** Siano $X_1\sim N(5,1)$ e $X_2\sim N(5,1)$, $X_1$ e $X_2$ indipendenti. Come si distribuisce
\[
\bar X = \frac 12 (X_1+X_2) ~~~?
\]

2.c **(Punti 2/91 $\rightarrow$ 0.68/31)** Siano $A$ e $B$ due eventi tali che $P(A)=0.3$ e $P(B)=0.3$. $A$ e $B$ possono essere incompatibili? (scegliere tra _sempre, mai, dipende_ e motivare la risposta)



### Esercizio 3

3.a **(Punti 14/91 $\rightarrow$ 4.77/31)** Un'urna contiene le seguenti palline numerate {3,4,5,6,7,12}. Si vine se esce un numero pari. Si estrae con reintroduzione per $n=81$ volte.
...
**Teorema del Limite Centrale (proporzione)** 
 ...
 Siano $X_1$,...,$X_n$, $n=81$ VC IID, tc $X_i\sim\text{Ber}(\pi=0.5)$$,\forall i$, posto:
      \[
      \hat\pi=\frac{S_n}n = \frac{X_1 + ... + X_n}n
      \]
      allora:\begin{eqnarray*}
...
4.a **(Punti 3/91 $\rightarrow$ 1.02/31)** Sia $\hat \beta_0$ lo stimatore dei minimi quadrati di $\beta_0$ del modello di regressione lineare.
\begin{eqnarray*}
  \hat\beta_0 &=&\bar y-  \hat\beta_1\bar x\\
\end{eqnarray*}
Dimostrare la consistenza di $\hat\beta_0$.

4.b **(Punti 3/91 $\rightarrow$ 1.02/31)** Cosa significa che gli stimatori di massima verosimiglianza sono asintoticamente a massima efficienza?

4.c **(Punti 3/91 $\rightarrow$ 1.02/31)** Definire gli errori di primo e secondo tipo.



4.d **(Punti 3/91 $\rightarrow$ 1.02/31)** Un sociologo sta conducendo uno studio sull'associazione tra l'orientamento politico e l'atteggiamento nei confronti del cambiamento climatico. Ha somministrato un questionario a 520 partecipanti, chiedendo loro di indicare il proprio orientamento politico (Conservatore, Progressista, Indipendente) e l'atteggiamento nei confronti del cambiamento climatico (Molto, poco, per nulla) preoccupato. L'obiettivo è determinare se c'è un'associazione significativa tra l'orientamento politico e l'atteggiamento nei confronti del cambiamento climatico.
...
6.a **(Punti 14/91 $\rightarrow$ 4.77/31)** Si è osservato $x_3=7$ e $y_3=22$, stimare il modello di regressione dove $Y$ viene spiegata da $X$ e calcolare il residuo per il punto $i=3$.
...
6.b **(Punti 3/91 $\rightarrow$ 1.02/31)** Scrivere la scomposizione della varianza e calcolarla per i dati in esame.
...
6.c **(Punti 2/91 $\rightarrow$ 0.68/31)** Stimare $\sigma^2_\varepsilon$.
...
6.d **(Punti 2/91 $\rightarrow$ 0.68/31)** Definire i punti influenti.

6.e **(Punti 2/91 $\rightarrow$ 0.68/31)** Se in un modello di regressione $r=0.35$, $\hat\sigma_X=1.2$ e $\hat\beta_1=0.5$, quanto varrà
...
1.d **(Punti 2/105 $\rightarrow$ 0.59/31)** La spesa media è pari a $\bar x=3.4838$, mentre la SD è pari a $SD=3.9497$.
...
3.a **(Punti 14/105 $\rightarrow$ 4.13/31)** Un'urna 3 premi da $\mbox{0}$ euro, 2 premi da $\mbox{1}$ euro e un premio da $\mbox{2}$ euro.
...
**Teorema del Limite Centrale (somma VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=100$ VC IID, tc $E(X_i)=\mu=0.6667$ e $V(X_i)=\sigma^2=0.5556,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
5.e **(Punti 2/105 $\rightarrow$ 0.59/31)** Se in un modello di regressione $r=0.55$, $\hat\sigma_X=0.9$ e $\hat\beta_1=1.5$, quanto varrà
$\hat\sigma_Y$, la standard deviation di $Y$?
...
1.d **(Punti 2/105 $\rightarrow$ 0.59/31)** La spesa media è pari a $5.6714$, mentre la varianza è pari a $19.5627$.
...
2.d **(Punti 2/105 $\rightarrow$ 0.59/31)** Sia $X$ una variabile casuale e sia $F$ la sa funzione di ripartizione. Siano $a$ e $b$ due numeri reali, $a<b$, esprimere
\[
P(a<X\leq b)
\]
in termini di $F$.
...
3.a **(Punti 14/105 $\rightarrow$ 4.13/31)** Un'urna 4 premi da $\mbox{0}$ euro, 3 premi da $\mbox{1}$ euro e 2 premi da $\mbox{2}$ euro.
Si estrae 50 volte con reintroduzione. 
...
**Teorema del Limite Centrale (media VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=50$ VC IID, tc $E(X_i)=\mu=0.7778$ e $V(X_i)=\sigma^2=0.6173,\forall i$, posto:
      \[
      \bar X=\frac{S_n}n =\frac{X_1 + ... + X_n}n
      \]
      allora:\begin{eqnarray*}
...
1.d **(Punti 2/105 $\rightarrow$ 0.59/31)** La spesa media è pari a $4.9551$, mentre la varianza è pari a $19.0807$.
...
3.a **(Punti 14/105 $\rightarrow$ 4.13/31)** Un'urna 4 premi da $\mbox{0}$ euro, 2 premi da $\mbox{1}$ euro.
Si estrae 50 volte con reintroduzione. 
...
**Teorema del Limite Centrale (somma di Bernoulli)** 
 ...
 Siano $X_1$,...,$X_n$, $n=50$ VC IID, tc $X_i\sim\text{Ber}(\pi=0.3333)$$,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
6.e **(Punti 2/105 $\rightarrow$ 0.59/31)** Se in un modello di regressione $r=0.55$, $\hat\sigma_Y=0.9$ e $\hat\beta_1=1.5$, quanto varrà
...
1.d **(Punti 2/105 $\rightarrow$ 0.59/31)** La spesa media è pari a $\bar x=3.5222$, mentre la SD è pari a $SD=4.2267$.
Se ogni famiglia spendesse 2 mila euro in più all'anno, quanto varrebbero la media e la SD dei dati trasformati?
...
3.a **(Punti 14/105 $\rightarrow$ 4.13/31)** Un'urna contiene 6 premi da $\mbox{0}$ euro, 3 premi da $\mbox{1}$ euro e un premio da $\mbox{2}$ euro.
Si estrae 100 volte con reintroduzione. 
...
**Teorema del Limite Centrale (somma VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=100$ VC IID, tc $E(X_i)=\mu=0.5$ e $V(X_i)=\sigma^2=0.45,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
4.b **(Punti 3/105 $\rightarrow$ 0.89/31)** Se $\hat\theta$ è lo stimatore di massima verosimiglianza 
...
5.e **(Punti 2/105 $\rightarrow$ 0.59/31)** Se in un modello di regressione $r=0.75$, $\hat\sigma_X=0.8$ e $\hat\beta_1=1.2$, calcolare
...
2.c **(Punti 2/105 $\rightarrow$ 0.59/31)** Se $A$ e $B$ sono due eventi diversi da $\emptyset$, se
$P(A|B)=0$ in che relazione sono $A$ e $B$?


2.d **(Punti 2/105 $\rightarrow$ 0.59/31)** Sia $X$ una variabile casuale con supporto $S_X=c\{-1,0,2\}$ e con funzione di probabilità
$$
f(x)=\begin{cases}
\frac 25, &\text{ se $x=-1$}\\
...
3.a **(Punti 14/105 $\rightarrow$ 4.13/31)** Un'urna 4 premi da $\mbox{0}$ euro, 1 premio da $\mbox{2}$ euro.
Si estrae 50 volte con reintroduzione. 
...
4.d **(Punti 3/105 $\rightarrow$ 0.89/31)**  In un'indagine sull'opinione sul reddito di inclusione sono stati intervistate 150 persone che vivono al nord e 180 che vivono al sud: 60 su 150 che vivono al nord sono favorevoli al reddito di cittadinanza mentre 95 su 180 che vivono al sud sono favorevoli. 
Messo a test
...
1.d **(Punti 2/105 $\rightarrow$ 0.59/31)** La spesa media è pari a $4.0009$, mentre la varianza è pari a $10.6517$.
Se ogni famiglia diminuisse la propria spesa del 2%, quanto varrebbero la media e la varianza dei dati così trasformati?
...
2.a **(Punti 14/105 $\rightarrow$ 4.13/31)**  Sia $X\sim N(6,0.5)$ e sia $Y\sim N(6,0.5)$, $X$ e $Y$ indipendenti sia $A=\{X>5\}$ e $B=\{Y<7\}$. 
Calcolare $P(A\cup B)$.
...
3.a **(Punti 14/105 $\rightarrow$ 4.13/31)** Un'urna 3 premi da $\mbox{0}$ euro, un premio da $\mbox{1}$ euro.
Si estrae 100 volte con reintroduzione. 
...
5.a **(Punti 14/105 $\rightarrow$ 4.13/31)**  In un'indagine sui consumi in beni alimentari sono stati intervistati 13 nuclei familiari al Nord d'Italia e 15 al Sud.
...
6.e **(Punti 2/105 $\rightarrow$ 0.59/31)** Se in un modello di regressione $r=0.55$, $\hat\sigma_Y=0.9$ e $\hat\beta_1=1.5$,  calcolare
$\hat\alpha_1$, la stima del coefficiente angolare del modello
...
2.d **(Punti 2/105 $\rightarrow$ 0.59/31)** Sia $X$ una variabile casuale con supporto $S_X=c\{-1,+1\}$ e con funzione di probabilità
$$
f(x)=\begin{cases}
\frac 25, &\text{ se $x=-1$}\\
\frac 35, &\text{ se $x=+1$}
...
3.a **(Punti 14/105 $\rightarrow$ 4.13/31)** Un'urna contiene 4 palline col numero $\mbox{-1}$ e 6 col $\mbox{1}$.
Si estrae 100 volte con reintroduzione. 
...
**Teorema del Limite Centrale (somma VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=100$ VC IID, tc $E(X_i)=\mu=0.2$ e $V(X_i)=\sigma^2=0.96,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
5.a **(Punti 11/105 $\rightarrow$ 3.25/31)** Sia \(X\) il reddito annuale dei manager italiani.
Si sceglie un campione di 30 manager italiani e si ottiene una
media di 85 mila euro con una deviazione standard pari a 15 mila euro.
...
5.b **(Punti 3/105 $\rightarrow$ 0.89/31)** È noto che il reddito medio annuale dei manager europei
è di 80 mila euro.
Verificare l'ipotesi
che il reddito medio annuale dei manager italiani sia uguale a quello
...
<!-- 6.f **(Punti NA/105 $\rightarrow$ NA/31)** Testare l'ipotesi che $\beta_1$ sia uguale a zero, contro l'alternativa che sia diverso per $\alpha=0.1,0.05,0.01,0.001$ e dare una valutazione approssimativa del $p_\text{value}$ (ad esempio il $p_\text{value}$ è minore di 0.001, compreso tra 0.05 e tra 0.01, ecc.). -->
...
2.d **(Punti 2/105 $\rightarrow$ 0.59/31)** Sia $X$ una variabile casuale con supporto $S_X=\{-1,0,1\}$ e con funzione di probabilità
$$
f(x)=\begin{cases}
\frac 13, &\text{ se $x=-1$}\\
...
3.a **(Punti 14/105 $\rightarrow$ 4.13/31)** Un'urna contiene 2 palline col numero $\mbox{-2}$, e 2 palline col numero $\mbox{-1}$ e 6 palline col numero $\mbox{+2}$.
Si estrae 50 volte con reintroduzione. 
...
**Teorema del Limite Centrale (proporzione)** 
 ...
 Siano $X_1$,...,$X_n$, $n=50$ VC IID, tc $X_i\sim\text{Ber}(\pi=0.6)$$,\forall i$, posto:
      \[
      \hat\pi=\frac{S_n}n = \frac{X_1 + ... + X_n}n
      \]
      allora:\begin{eqnarray*}
...
4.d **(Punti 3/105 $\rightarrow$ 0.89/31)**  In un'indagine sull'opinione sull'autonomia differenziata sono stati intervistate 180 persone che vivono al nord e 130 che vivono al sud: 108 su 180 che vivono al nord sono favorevoli al reddito di cittadinanza mentre 55 su 130 che vivono al sud sono favorevoli. 
Messo a test
...
<!-- 6.f **(Punti NA/105 $\rightarrow$ NA/31)** Testare l'ipotesi che $\beta_0$ sia uguale a 12, contro l'alternativa che sia maggiore per $\alpha=0.1,0.05,0.01,0.001$ e dare una valutazione approssimativa del $p_\text{value}$ (ad esempio il $p_\text{value}$ è minore di 0.001, compreso tra 0.05 e tra 0.01, ecc.). -->
...
1.d **(Punti 2/105 $\rightarrow$ 0.59/31)** Se $\{x_1,...,x_n\}$ è una serie di dati con media aritmetica $\bar x=\frac 1n\sum_i x_i$ e varianza $\sigma_X^2=\frac 1n\sum_i(x-\bar x)^2$. Posto
$$
...
2.a **(Punti 14/105 $\rightarrow$ 4.13/31)** Sia $X\sim N(1,1.5)$ e sia $Y\sim N(-1,1.5)$, $X$ e $Y$ indipendenti sia $A=\{X>0\}$ e $B=\{Y<0\}$. 
Calcolare $P(A\cup B)$.
...
**Teorema del Limite Centrale (somma VC qualunque)** 
 ...
 Siano $X_1$,...,$X_n$, $n=150$ VC IID, tc $E(X_i)=\mu=0.6$ e $V(X_i)=\sigma^2=3.04,\forall i$, posto:
      \[
      S_n = X_1 + ... + X_n
      \]
      allora:\begin{eqnarray*}
...
6.e **(Punti 2/105 $\rightarrow$ 0.59/31)** Se in un modello di regressione $r=0.55$, $\hat\sigma_Y=0.9$ e $\hat\sigma_X=1.9$, calcolare $\hat\beta_1$ e
