...
\tightlist
\item
  Mario, ingegnere \textbf{senior} con lunga esperienza sul campo, ritiene che la probabilità che una valvola presenti un malfunzionamento sia pari a \(\pi_M = 0.1\).
\item
...
Per acquisire elementi informativi, viene selezionato un campione casuale di \textbf{8 valvole}. Tra queste, \textbf{5 presentano malfunzionamenti}.

1.a Costruire le distribuzioni condizionate di \(X\) a \(\pi\). Determinare, per ciascuna delle due ipotesi, la probabilità di osservare 5 malfunzionamenti su 8 valvole.
...
1.b Costruire la distribuzione
