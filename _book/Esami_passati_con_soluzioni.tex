...
\$\#(X\textgreater x\_\{ 0.75 \})\approx 0.25 \times 250 = 62 \$
...
\$\#(X\textgreater x\_\{ 0.25 \})\approx 0.75 \times 160 = 120 \$
...
\$\#(X\textgreater x\_\{ 0.55 \})\approx 0.45 \times 160 = 72 \$
...
\$\#(x\_\{ 0.15 \}\textless X\textless x\_\{ 0.85 \})\approx 0.7 \times 150 = 105 \$
...
\$\#(x\_\{ 0.25 \}\textless X\textless x\_\{ 0.75 \})\approx 0.5 \times 200 = 100 \$
